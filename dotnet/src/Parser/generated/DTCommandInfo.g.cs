                ...
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:commandType;2":
                        ...
                        else
                        {
                            ...
                            DTCommandTypeInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.commandTypeValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "commandType", null, null, 0, isPlural: false, idRequired: true, typeRequired: true, globalize: globalize, allowReservedIds: allowReservedIds, allowIdReferenceSyntax: allowIdReferenceSyntax, ignoreElementsWithAutoIDsAndDuplicateNames: ignoreElementsWithAutoIDsAndDuplicateNames, allowedVersions: this.commandTypeAllowedVersionsV2);
                        }
                    ...
                    case "dtmi:dtdl:property:request;2":
                        ...
                        else
                        {
                            ...
                            DTCommandPayloadInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.requestValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "request", null, null, 0, isPlural: false, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, allowIdReferenceSyntax: allowIdReferenceSyntax, ignoreElementsWithAutoIDsAndDuplicateNames: ignoreElementsWithAutoIDsAndDuplicateNames, allowedVersions: this.requestAllowedVersionsV2);
                        }
                    ...
                    case "dtmi:dtdl:property:response;2":
                        ...
                        else
                        {
                            ...
                            DTCommandPayloadInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.responseValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "response", null, null, 0, isPlural: false, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, allowIdReferenceSyntax: allowIdReferenceSyntax, ignoreElementsWithAutoIDsAndDuplicateNames: ignoreElementsWithAutoIDsAndDuplicateNames, allowedVersions: this.responseAllowedVersionsV2);
                        }
            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:commandType;3":
                        ...
                        {
                            commandTypeProperty = prop;
                            DTCommandTypeInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.commandTypeValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "commandType", null, null, 0, isPlural: false, idRequired: true, typeRequired: true, globalize: globalize, allowReservedIds: allowReservedIds, allowIdReferenceSyntax: allowIdReferenceSyntax, ignoreElementsWithAutoIDsAndDuplicateNames: ignoreElementsWithAutoIDsAndDuplicateNames, allowedVersions: this.commandTypeAllowedVersionsV3);
                        }
                    ...
                    case "dtmi:dtdl:property:request;3":
                        ...
                        {
                            requestProperty = prop;
                            DTCommandRequestInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.requestValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "request", null, null, 0, isPlural: false, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, allowIdReferenceSyntax: allowIdReferenceSyntax, ignoreElementsWithAutoIDsAndDuplicateNames: ignoreElementsWithAutoIDsAndDuplicateNames, allowedVersions: this.requestAllowedVersionsV3);
                        }
                    ...
                    case "dtmi:dtdl:property:response;3":
                        ...
                        {
                            responseProperty = prop;
                            DTCommandResponseInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.responseValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "response", null, null, 0, isPlural: false, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, allowIdReferenceSyntax: allowIdReferenceSyntax, ignoreElementsWithAutoIDsAndDuplicateNames: ignoreElementsWithAutoIDsAndDuplicateNames, allowedVersions: this.responseAllowedVersionsV3);
                        }
