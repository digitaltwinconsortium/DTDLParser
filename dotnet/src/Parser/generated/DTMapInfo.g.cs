            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:mapKey;2":
                        ...
                        {
                            mapKeyProperty = prop;
                            DTMapKeyInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.mapKeyValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "mapKey", null, null, 1, isPlural: false, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, allowIdReferenceSyntax: allowIdReferenceSyntax, ignoreElementsWithAutoIDsAndDuplicateNames: ignoreElementsWithAutoIDsAndDuplicateNames, allowedVersions: this.mapKeyAllowedVersionsV2);
                        }
                    ...
                    case "dtmi:dtdl:property:mapValue;2":
                        ...
                        else
                        {
                            ...
                            DTMapValueInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.mapValueValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "mapValue", null, null, 1, isPlural: false, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, allowIdReferenceSyntax: allowIdReferenceSyntax, ignoreElementsWithAutoIDsAndDuplicateNames: ignoreElementsWithAutoIDsAndDuplicateNames, allowedVersions: this.mapValueAllowedVersionsV2);
                        }
            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:mapKey;3":
                        ...
                        {
                            mapKeyProperty = prop;
                            DTMapKeyInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.mapKeyValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "mapKey", null, null, 1, isPlural: false, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, allowIdReferenceSyntax: allowIdReferenceSyntax, ignoreElementsWithAutoIDsAndDuplicateNames: ignoreElementsWithAutoIDsAndDuplicateNames, allowedVersions: this.mapKeyAllowedVersionsV3);
                        }
                    ...
                    case "dtmi:dtdl:property:mapValue;3":
                        ...
                        {
                            mapValueProperty = prop;
                            DTMapValueInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.mapValueValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "mapValue", null, null, 1, isPlural: false, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, allowIdReferenceSyntax: allowIdReferenceSyntax, ignoreElementsWithAutoIDsAndDuplicateNames: ignoreElementsWithAutoIDsAndDuplicateNames, allowedVersions: this.mapValueAllowedVersionsV3);
                        }
