...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTArrayInfo : DTComplexSchemaInfo, ITypeChecker, IConstrainer, IPropertyInstanceBinder, IEquatable<DTArrayInfo>
    {
        ...
        private HashSet<int> elementSchemaAllowedVersionsV2 = new HashSet<int>() { 2 };
        ...
        private List<ValueConstraint> elementSchemaValueConstraints = null;

        private string commentPropertyLayer = null;

        private string elementSchemaPropertyLayer = null;
        ...
        static DTArrayInfo()
        {
            VersionlessTypes.Add("dtmi:dtdl:class:Array");
            ...
            PropertyNames.Add("elementSchema");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DTArrayInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the Array.</param>
        /// <param name="id">Identifier for the Array.</param>
        /// <param name="childOf">Identifier of the parent element in which this Array is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Array.</param>
        /// <param name="definedIn">Identifier of the partition in which this Array is defined.</param>
        internal DTArrayInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.Array)
        {
        ...
        internal DTArrayInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type Array in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type Array.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:Array;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// </summary>
        /// <value>The 'elementSchema' property of the DTDL element.</value>
        public DTSchemaInfo ElementSchema { get; internal set; }
        ...
        /// <summary>
        /// Determines whether two <c>DTArrayInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTArrayInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTArrayInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTArrayInfo x, DTArrayInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTArrayInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTArrayInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTArrayInfo other)
        {
            return base.DeepEquals(other)
                && (this.ElementSchema?.DeepEquals(other.ElementSchema) ?? ReferenceEquals(null, other.ElementSchema))
        ...
        /// <summary>
        /// Validate a <c>JsonElement</c> to determine whether it is a JSON array that conforms to the specific Array element defined in the model.
        /// </summary>
        ...
        void IConstrainer.AddPropertyValueConstraint(string propertyName, ValueConstraint valueConstraint)
        {
            switch (propertyName)
            {
                ...
                case "displayName":
                    ...
                    break;
                case "elementSchema":
                    if (this.elementSchemaValueConstraints == null)
                    {
                        this.elementSchemaValueConstraints = new List<ValueConstraint>();
                    }

                    this.elementSchemaValueConstraints.Add(valueConstraint);
                    break;
            }
        }
        ...
        void IPropertyInstanceBinder.AddInstanceProperty(string propertyName, string instancePropertyName)
        {
            switch (propertyName)
            {
                case "elementSchema":
                    ...
                    {
                        this.elementSchemaInstanceProperties = new List<string>();
                    }

                    this.elementSchemaInstanceProperties.Add(instancePropertyName);
                    break;
            }
        }

        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTArrayInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool allowIdReferenceSyntax, bool ignoreElementsWithAutoIDsAndDuplicateNames, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTArrayInfo elementInfo = (DTArrayInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTArrayInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTArrayInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        internal override bool TryGetDescendantSchemaArray(out Dtmi elementId, out Dictionary<string, JsonLdElement> excludedElts)
        {
            ...
            if (this.ElementSchema != null)
            {
                if (this.ElementSchema.TryGetDescendantSchemaArray(out elementId, out excludedElts))
                {
            ...
            switch (propertyName)
            {
                ...
                case "dtmi:dtdl:property:elementSchema;3":
                    if (this.ElementSchema != null)
                    {
                        ...
                        {
                            JsonLdProperty extantProp = this.JsonLdElements[this.elementSchemaPropertyLayer].Properties.FirstOrDefault(p => p.Name == "elementSchema");
                            parsingErrorCollection.Notify(
                                "inconsistentObjectValues",
                                elementId: this.Id,
                                propertyName: "elementSchema",
                                propertyValue: element.Id.ToString(),
                                valueRestriction: this.ElementSchema.Id.ToString(),
                    ...
                    {
                        this.ElementSchema = (DTSchemaInfo)element;
                        this.elementSchemaPropertyLayer = layer;
                    }
        ...
        internal override void CheckDescendantEnumValueDatatype(Dtmi ancestorId, Dictionary<string, JsonLdElement> ancestorElts, Type datatype, ParsingErrorCollection parsingErrorCollection)
        {
            if (this.checkedDescendantEnumValueDatatype != datatype)
            {
                ...
                if (this.ElementSchema != null)
                {
                    this.ElementSchema.CheckDescendantEnumValueDatatype(ancestorId, ancestorElts, datatype, parsingErrorCollection);
                }
            }
        }
                ...
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:elementSchema;2":
                        ...
                        else
                        {
                            ...
                            DTSchemaInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.elementSchemaValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "elementSchema", null, null, 1, isPlural: false, idRequired: false, typeRequired: true, globalize: globalize, allowReservedIds: allowReservedIds, allowIdReferenceSyntax: allowIdReferenceSyntax, ignoreElementsWithAutoIDsAndDuplicateNames: ignoreElementsWithAutoIDsAndDuplicateNames, allowedVersions: this.elementSchemaAllowedVersionsV2);
                        }
            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:elementSchema;3":
                        ...
                        {
                            elementSchemaProperty = prop;
                            DTSchemaInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.elementSchemaValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "elementSchema", null, null, 1, isPlural: false, idRequired: false, typeRequired: true, globalize: globalize, allowReservedIds: allowReservedIds, allowIdReferenceSyntax: allowIdReferenceSyntax, ignoreElementsWithAutoIDsAndDuplicateNames: ignoreElementsWithAutoIDsAndDuplicateNames, allowedVersions: this.elementSchemaAllowedVersionsV3);
                        }
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:Array;{this.LanguageMajorVersion}");
            }

            jsonWriter.WriteString("elementSchema", this.ElementSchema?.Id?.ToString());
        }
