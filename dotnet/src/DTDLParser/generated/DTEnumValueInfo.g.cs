...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTEnumValueInfo : DTNamedEntityInfo, ITypeChecker, IConstrainer, IEquatable<DTEnumValueInfo>
    {
        ...
        private List<ValueConstraint> enumValueValueConstraints = null;

        private List<ValueConstraint> nameValueConstraints = null;

        private string commentPropertyLayer = null;

        private string enumValueDatatype = string.Empty;

        private string enumValuePropertyLayer = null;
        ...
        static DTEnumValueInfo()
        {
            ...
            BadTypeActionFormat[2] = "Provide a @type{line3} of EnumValue, or provide a value for property '{property}'{line1} with @type of EnumValue.";
            BadTypeActionFormat[3] = "Provide a @type{line3} of EnumValue, or provide a value for property '{property}'{line1} with @type of EnumValue.";
            BadTypeActionFormat[4] = "Provide a @type{line3} of EnumValue, or provide a value for property '{property}'{line1} with @type of EnumValue.";

            BadTypeCauseFormat[2] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of EnumValue.";
            BadTypeCauseFormat[3] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of EnumValue.";
            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of EnumValue.";

            BadTypeLocatedCauseFormat[2] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of EnumValue.";
            BadTypeLocatedCauseFormat[3] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of EnumValue.";
            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of EnumValue.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DTEnumValueInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the EnumValue.</param>
        /// <param name="id">Identifier for the EnumValue.</param>
        /// <param name="childOf">Identifier of the parent element in which this EnumValue is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this EnumValue.</param>
        /// <param name="definedIn">Identifier of the partition in which this EnumValue is defined.</param>
        internal DTEnumValueInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.EnumValue)
        {
            this.EnumValue = new object();
        ...
        internal DTEnumValueInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type EnumValue in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type EnumValue.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:EnumValue;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// </summary>
        /// <value>The 'enumValue' property of the DTDL element.</value>
        ...
        /// <summary>
        /// Determines whether two <c>DTEnumValueInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTEnumValueInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTEnumValueInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTEnumValueInfo x, DTEnumValueInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTEnumValueInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTEnumValueInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTEnumValueInfo other)
        {
            return base.DeepEquals(other)
                && ((IComparable)this.EnumValue).CompareTo((IComparable)other.EnumValue) == 0
        ...
        /// <param name="other">The other <c>DTEnumValueInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTEnumValueInfo other)
        {
        ...
        public override int GetHashCode()
        {
            ...
            unchecked
            {
                ...
                hashCode = (hashCode * 131) + this.EnumValue.GetHashCode();
            }
        ...
        /// <summary>
        /// Validate a <c>JsonElement</c> to determine whether it conforms to the specific EnumValue element defined in the model.
        /// </summary>
        ...
        void IConstrainer.AddPropertyValueConstraint(string propertyName, ValueConstraint valueConstraint)
        {
            switch (propertyName)
            {
                ...
                case "displayName":
                    ...
                    break;
                case "enumValue":
                    if (this.enumValueValueConstraints == null)
                    {
                        this.enumValueValueConstraints = new List<ValueConstraint>();
                    }

                    this.enumValueValueConstraints.Add(valueConstraint);
                    break;
                case "name":
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTEnumValueInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTEnumValueInfo elementInfo = (DTEnumValueInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTEnumValueInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTEnumValueInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTEnumValueInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        internal override void CheckDescendantEnumValueDatatype(Dtmi ancestorId, Dictionary<string, JsonLdElement> ancestorElts, Type datatype, ParsingErrorCollection parsingErrorCollection)
        {
            if (this.checkedDescendantEnumValueDatatype != datatype)
            {
                ...
                if (this.EnumValue.GetType() != datatype)
                {
                    JsonLdProperty mismatchedProp = this.JsonLdElements.FirstOrDefault(e => e.Value.Properties.Any(p => p.Name == "enumValue")).Value?.Properties?.First(p => p.Name == "enumValue");
                    JsonLdProperty requirementProp = ancestorElts.FirstOrDefault(e => e.Value.Properties.Any(p => p.Name == "valueSchema")).Value?.Properties?.First(p => p.Name == "valueSchema");

                    parsingErrorCollection.Notify(
                        "nonConformantDatatype",
                        elementId: this.Id,
                        propertyName: "enumValue",
                        governingId: ancestorId,
                        governingPropertyName: "valueSchema",
                        propertyValue: this.EnumValue.ToString(),
                        datatype: Helpers.GetDatytypeString(datatype),
                        incidentProperty: mismatchedProp,
                        governingProperty: requirementProp);
                }
            }
        }
        ...
        internal override void ParsePropertiesV2(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, AggregateContext aggregateContext, HashSet<Dtmi> immediateSupplementalTypeIds, List<string> immediateUndefinedTypes, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi definedIn, bool globalize, bool allowReservedIds, bool tolerateSolecisms)
        {
            ...
            JsonLdProperty enumValueProperty = null;
                    ...
                    case "dtmi:dtdl:property:enumValue;2":
                        if (enumValueProperty != null)
                        {
                            parsingErrorCollection.Notify(
                                ...
                                propertyName: "enumValue",
                                incidentProperty: prop,
                                extantProperty: enumValueProperty,
                                layer: layer);
                        }
                        else
                        {
                            enumValueProperty = prop;
                            object newEnumValue = ValueParser.ParseSingularLiteralValueCollection(aggregateContext, this.Id, "enumValue", prop.Values, layer, parsingErrorCollection, isOptional: false, typeFragment: out this.enumValueDatatype);
                            if (this.enumValuePropertyLayer != null)
                            {
                                if (((IComparable)this.EnumValue).CompareTo((IComparable)newEnumValue) != 0)
                                {
                                    JsonLdProperty extantProp = this.JsonLdElements[this.enumValuePropertyLayer].Properties.FirstOrDefault(p => p.Name == "enumValue");
                                    parsingErrorCollection.Notify(
                                        "inconsistentLiteralValues",
                                        elementId: this.Id,
                                        propertyName: "enumValue",
                                        propertyValue: newEnumValue.ToString(),
                                        valueRestriction: this.EnumValue.ToString(),
                                        incidentProperty: prop,
                                        extantProperty: extantProp,
                                        layer: layer);
                                }
                            ...
                            else
                            {
                                ...
                                this.enumValuePropertyLayer = layer;

                                if (this.enumValueValueConstraints != null)
                                {
                                    foreach (ValueConstraint valueConstraint in this.enumValueValueConstraints)
                                    {
                                        if (valueConstraint.RequiredLiteral != null && !valueConstraint.RequiredLiteral.Equals(newEnumValue))
                                        {
                                            parsingErrorCollection.Notify(
            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:displayName;4":
                        ...
                        continue;
                    case "enumValue":
                    case "dtmi:dtdl:property:enumValue;4":
                        if (enumValueProperty != null)
                        {
                            parsingErrorCollection.Notify(
                                "duplicatePropertyName",
        ...
        private bool ValidateInstanceV2(JsonElement instanceElt, string instanceName, List<string> violations)
        {
            if (!LiteralValidator.HasValue(instanceElt, this.EnumValue))
            {
                violations.Add($">>{instanceElt.GetRawText()}<< does not have value {this.EnumValue}");
                return false;
            }
