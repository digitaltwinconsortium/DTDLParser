...
namespace DTDLParser.Models
{
    ...
    /// <summary>
    /// Class <c>DTUnsignedByteInfo</c> corresponds to an element of type UnsignedByte in a DTDL model.
    /// </summary>
    public class DTUnsignedByteInfo : DTNumericSchemaInfo, ITypeChecker, IConstrainer, IEquatable<DTUnsignedByteInfo>
    {
        ...
        static DTUnsignedByteInfo()
        {
            ...
            VersionlessTypes.Add("dtmi:dtdl:class:UnsignedByte");
            ...
            BadTypeActionFormat[4] = "Use this standard value for property '{property}'{line1}: unsignedByte.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DTUnsignedByteInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the UnsignedByte.</param>
        /// <param name="id">Identifier for the UnsignedByte.</param>
        /// <param name="childOf">Identifier of the parent element in which this UnsignedByte is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this UnsignedByte.</param>
        /// <param name="definedIn">Identifier of the partition in which this UnsignedByte is defined.</param>
        internal DTUnsignedByteInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.UnsignedByte)
        {
        ...
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this UnsignedByte.</param>
        /// <param name="definedIn">Identifier of the partition in which this UnsignedByte is defined.</param>
        /// <param name="entityKind">The kind of Entity, which may be other than UnsignedByte if this constructor is called from a derived class.</param>
        internal DTUnsignedByteInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type UnsignedByte in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type UnsignedByte.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:UnsignedByte;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTUnsignedByteInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTUnsignedByteInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTUnsignedByteInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTUnsignedByteInfo x, DTUnsignedByteInfo y)
        {
        ...
        /// <summary>
        /// Determines whether two <c>DTUnsignedByteInfo</c> objects are equal.
        /// </summary>
        /// <param name="x">One <c>DTUnsignedByteInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTUnsignedByteInfo</c> object to compare to the first.</param>
        ...
        /// <summary>
        /// Compares to another <c>DTUnsignedByteInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTUnsignedByteInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTUnsignedByteInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTUnsignedByteInfo)other);
        }
        ...
        /// <summary>
        /// Compares to another <c>DTUnsignedByteInfo</c> object.
        /// </summary>
        /// <param name="other">The other <c>DTUnsignedByteInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTUnsignedByteInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTUnsignedByteInfo)other);
        }
        ...
        {
            return otherObj is DTUnsignedByteInfo other && this.Equals(other);
        }
        ...
        /// <summary>
        /// Validate a <c>JsonElement</c> to determine whether it is a numeric value that conforms to the XSD definition of 'unsignedByte'.
        /// </summary>
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTUnsignedByteInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTUnsignedByteInfo elementInfo = (DTUnsignedByteInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTUnsignedByteInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTUnsignedByteInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTUnsignedByteInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        /// <summary>
        /// Parse the properties in a JSON UnsignedByte object.
        /// </summary>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:UnsignedByte;{this.LanguageMajorVersion}");
            }
        }
        ...
        private bool ValidateInstanceV4(JsonElement instanceElt, string instanceName, List<string> violations)
        {
            ...
            if (!byte.TryParse(instanceElt.GetRawText(), out byte _))
            {
                violations.Add($"{instanceElt.GetRawText()} does not conform to the XSD definition of 'unsignedByte'");
                return false;
            }
