...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public abstract class DTNumericSchemaInfo : DTPrimitiveSchemaInfo, ITypeChecker, IEquatable<DTNumericSchemaInfo>
    {
        ...
        static DTNumericSchemaInfo()
        {
            ...
            BadTypeActionFormat[4] = "Use one of these standard values for property '{property}'{line1}: double, float, integer, long.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DTNumericSchemaInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the NumericSchema.</param>
        /// <param name="id">Identifier for the NumericSchema.</param>
        /// <param name="childOf">Identifier of the parent element in which this NumericSchema is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this NumericSchema.</param>
        ...
        internal DTNumericSchemaInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// </summary>
        /// <value>The DTMI for the DTDL type NumericSchema.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:NumericSchema;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTNumericSchemaInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTNumericSchemaInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTNumericSchemaInfo</c> object to compare to the first.</param>
        ...
        /// <summary>
        /// Compares to another <c>DTNumericSchemaInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTNumericSchemaInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTNumericSchemaInfo)other);
        }
        ...
        {
            return otherObj is DTNumericSchemaInfo other && this.Equals(other);
        }
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTNumericSchemaInfo)other);
        }
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object of type <c>DTNumericSchemaInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTNumericSchemaInfo elementInfo = (DTNumericSchemaInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for a subclass of type <c>DTNumericSchemaInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTNumericSchemaInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of type <c>DTNumericSchemaInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        {
            throw new Exception($"attempt to add type {id} to non-augmentable type DTNumericSchemaInfo");
        }
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:NumericSchema;{this.LanguageMajorVersion}");
            }
        }
