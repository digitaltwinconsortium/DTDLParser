...
namespace DTDLParser.Models
{
    ...
    public abstract class DTSchemaFieldInfo : DTNamedEntityInfo, ITypeChecker, IEquatable<DTSchemaFieldInfo>
    {
        ...
        static DTSchemaFieldInfo()
        {
            ...
            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of CommandRequest, CommandResponse, Field, or MapValue.";
            ...
            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of CommandRequest, CommandResponse, Field, or MapValue.";
        }
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:SchemaField;{this.LanguageMajorVersion}");
            }
