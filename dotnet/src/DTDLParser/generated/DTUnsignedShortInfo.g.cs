...
namespace DTDLParser.Models
{
    ...
    /// <summary>
    /// Class <c>DTUnsignedShortInfo</c> corresponds to an element of type UnsignedShort in a DTDL model.
    /// </summary>
    public class DTUnsignedShortInfo : DTNumericSchemaInfo, ITypeChecker, IConstrainer, IEquatable<DTUnsignedShortInfo>
    {
        ...
        static DTUnsignedShortInfo()
        {
            ...
            VersionlessTypes.Add("dtmi:dtdl:class:UnsignedShort");
            ...
            BadTypeActionFormat[4] = "Use this standard value for property '{property}'{line1}: unsignedShort.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DTUnsignedShortInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the UnsignedShort.</param>
        /// <param name="id">Identifier for the UnsignedShort.</param>
        /// <param name="childOf">Identifier of the parent element in which this UnsignedShort is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this UnsignedShort.</param>
        /// <param name="definedIn">Identifier of the partition in which this UnsignedShort is defined.</param>
        internal DTUnsignedShortInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.UnsignedShort)
        {
        ...
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this UnsignedShort.</param>
        /// <param name="definedIn">Identifier of the partition in which this UnsignedShort is defined.</param>
        /// <param name="entityKind">The kind of Entity, which may be other than UnsignedShort if this constructor is called from a derived class.</param>
        internal DTUnsignedShortInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// </summary>
        /// <value>The DTMI for the DTDL type UnsignedShort.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:UnsignedShort;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTUnsignedShortInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTUnsignedShortInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTUnsignedShortInfo</c> object to compare to the first.</param>
        ...
        /// <summary>
        /// Determines whether two <c>DTUnsignedShortInfo</c> objects are equal.
        /// </summary>
        /// <param name="x">One <c>DTUnsignedShortInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTUnsignedShortInfo</c> object to compare to the first.</param>
        ...
        /// <summary>
        /// Compares to another <c>DTUnsignedShortInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTUnsignedShortInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTUnsignedShortInfo)other);
        }
        ...
        /// <summary>
        /// Compares to another <c>DTUnsignedShortInfo</c> object.
        /// </summary>
        /// <param name="other">The other <c>DTUnsignedShortInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTUnsignedShortInfo)other);
        }
        ...
        {
            return otherObj is DTUnsignedShortInfo other && this.Equals(other);
        }
        ...
        /// <summary>
        /// Validate a <c>JsonElement</c> to determine whether it is a numeric value that conforms to the XSD definition of 'unsignedShort'.
        /// </summary>
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTUnsignedShortInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTUnsignedShortInfo elementInfo = (DTUnsignedShortInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTUnsignedShortInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTUnsignedShortInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTUnsignedShortInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        /// <summary>
        /// Parse the properties in a JSON UnsignedShort object.
        /// </summary>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:UnsignedShort;{this.LanguageMajorVersion}");
            }
        }
        ...
        private bool ValidateInstanceV4(JsonElement instanceElt, string instanceName, List<string> violations)
        {
            ...
            if (!ushort.TryParse(instanceElt.GetRawText(), out ushort _))
            {
                violations.Add($"{instanceElt.GetRawText()} does not conform to the XSD definition of 'unsignedShort'");
                return false;
            }
