...
namespace DTDLParser
{
    ...
    internal static class MaterialTypeNameCollection
    {
        ...
        static MaterialTypeNameCollection()
        {
            ...
            TypeNames.Add("dtmi:dtdl:class:Array;4");
