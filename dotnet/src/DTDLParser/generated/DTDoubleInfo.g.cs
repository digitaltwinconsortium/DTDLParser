...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTDoubleInfo : DTNumericSchemaInfo, ITypeChecker, IConstrainer, IEquatable<DTDoubleInfo>
    {
        ...
        static DTDoubleInfo()
        {
            VersionlessTypes.Add("dtmi:dtdl:class:Double");
            ...
            BadTypeActionFormat[2] = "Use this standard value for property '{property}'{line1}: double.";
            BadTypeActionFormat[3] = "Use this standard value for property '{property}'{line1}: double.";
            BadTypeActionFormat[4] = "Use this standard value for property '{property}'{line1}: double.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DTDoubleInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the Double.</param>
        /// <param name="id">Identifier for the Double.</param>
        /// <param name="childOf">Identifier of the parent element in which this Double is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Double.</param>
        /// <param name="definedIn">Identifier of the partition in which this Double is defined.</param>
        internal DTDoubleInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.Double)
        {
        ...
        internal DTDoubleInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type Double in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type Double.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:Double;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTDoubleInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTDoubleInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTDoubleInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTDoubleInfo x, DTDoubleInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTDoubleInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTDoubleInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTDoubleInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTDoubleInfo)other);
        }
        ...
        /// <param name="other">The other <c>DTDoubleInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTDoubleInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTDoubleInfo)other);
        }
        ...
        {
            return otherObj is DTDoubleInfo other && this.Equals(other);
        }
        ...
        /// <summary>
        /// Validate a <c>JsonElement</c> to determine whether it is a numeric value that conforms to the XSD definition of 'double'.
        /// </summary>
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTDoubleInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTDoubleInfo elementInfo = (DTDoubleInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTDoubleInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTDoubleInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTDoubleInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:Double;{this.LanguageMajorVersion}");
            }
        }
        ...
        private bool ValidateInstanceV2(JsonElement instanceElt, string instanceName, List<string> violations)
        {
            ...
            if (!double.TryParse(instanceElt.GetRawText(), out double val) || double.IsInfinity(val))
            {
