...
namespace DTDLParser.Models
{
    ...
    /// <summary>
    /// Class <c>DTDecimalInfo</c> corresponds to an element of type Decimal in a DTDL model.
    /// </summary>
    public class DTDecimalInfo : DTNumericSchemaInfo, ITypeChecker, IConstrainer, IEquatable<DTDecimalInfo>
    {
        ...
        static DTDecimalInfo()
        {
            VersionlessTypes.Add("dtmi:dtdl:class:Decimal");
            ...
            BadTypeActionFormat[4] = "Use this standard value for property '{property}'{line1}: decimal.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DTDecimalInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the Decimal.</param>
        /// <param name="id">Identifier for the Decimal.</param>
        /// <param name="childOf">Identifier of the parent element in which this Decimal is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Decimal.</param>
        /// <param name="definedIn">Identifier of the partition in which this Decimal is defined.</param>
        internal DTDecimalInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.Decimal)
        {
        ...
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Decimal.</param>
        /// <param name="definedIn">Identifier of the partition in which this Decimal is defined.</param>
        /// <param name="entityKind">The kind of Entity, which may be other than Decimal if this constructor is called from a derived class.</param>
        internal DTDecimalInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type Decimal in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type Decimal.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:Decimal;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTDecimalInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTDecimalInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTDecimalInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTDecimalInfo x, DTDecimalInfo y)
        {
        ...
        /// <summary>
        /// Determines whether two <c>DTDecimalInfo</c> objects are equal.
        /// </summary>
        /// <param name="x">One <c>DTDecimalInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTDecimalInfo</c> object to compare to the first.</param>
        ...
        /// <summary>
        /// Compares to another <c>DTDecimalInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTDecimalInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTDecimalInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTDecimalInfo)other);
        }
        ...
        /// <summary>
        /// Compares to another <c>DTDecimalInfo</c> object.
        /// </summary>
        /// <param name="other">The other <c>DTDecimalInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTDecimalInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTDecimalInfo)other);
        }
        ...
        {
            return otherObj is DTDecimalInfo other && this.Equals(other);
        }
        ...
        /// <summary>
        /// Validate a <c>JsonElement</c> to determine whether it is a string value that conforms to the XSD definition of 'decimal'.
        /// </summary>
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTDecimalInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTDecimalInfo elementInfo = (DTDecimalInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTDecimalInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTDecimalInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTDecimalInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        /// <summary>
        /// Parse the properties in a JSON Decimal object.
        /// </summary>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:Decimal;{this.LanguageMajorVersion}");
            }
        }
        ...
        private bool ValidateInstanceV4(JsonElement instanceElt, string instanceName, List<string> violations)
        {
            ...
            {
                violations.Add($"\"{instanceElt.GetString()}\" does not conform to the XSD definition of 'decimal'");
                return false;
            }
