...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTMapValueInfo : DTSchemaFieldInfo, ITypeChecker, IConstrainer, IPropertyInstanceBinder, IEquatable<DTMapValueInfo>
    {
        ...
        static DTMapValueInfo()
        {
            VersionlessTypes.Add("dtmi:dtdl:class:Entity");
            VersionlessTypes.Add("dtmi:dtdl:class:MapValue");
            ...
            BadTypeActionFormat[2] = "Provide a @type{line3} of MapValue, or provide a value for property '{property}'{line1} with @type of MapValue.";
            BadTypeActionFormat[3] = "Provide a @type{line3} of MapValue, or provide a value for property '{property}'{line1} with @type of MapValue.";
            BadTypeActionFormat[4] = "Provide a @type{line3} of MapValue, or provide a value for property '{property}'{line1} with @type of MapValue.";

            BadTypeCauseFormat[2] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of MapValue.";
            BadTypeCauseFormat[3] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of MapValue.";
            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of MapValue.";

            BadTypeLocatedCauseFormat[2] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of MapValue.";
            BadTypeLocatedCauseFormat[3] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of MapValue.";
            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of MapValue.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DTMapValueInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the MapValue.</param>
        /// <param name="id">Identifier for the MapValue.</param>
        /// <param name="childOf">Identifier of the parent element in which this MapValue is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this MapValue.</param>
        /// <param name="definedIn">Identifier of the partition in which this MapValue is defined.</param>
        internal DTMapValueInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.MapValue)
        {
        ...
        internal DTMapValueInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type MapValue in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type MapValue.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:MapValue;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTMapValueInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTMapValueInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTMapValueInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTMapValueInfo x, DTMapValueInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTMapValueInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTMapValueInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTMapValueInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTMapValueInfo)other);
        }
        ...
        /// <param name="other">The other <c>DTMapValueInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTMapValueInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTMapValueInfo)other);
        }
        ...
        {
            return otherObj is DTMapValueInfo other && this.Equals(other);
        }
        ...
        /// <summary>
        /// Validate a <c>JsonElement</c> to determine whether it conforms to the specific MapValue element defined in the model.
        /// </summary>
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTMapValueInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTMapValueInfo elementInfo = (DTMapValueInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTMapValueInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTMapValueInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTMapValueInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:MapValue;{this.LanguageMajorVersion}");
            }
        }
        ...
        {
            if (!this.Schema.ValidateInstance(instanceElt, instanceName, violations))
            {
                return false;
            }
