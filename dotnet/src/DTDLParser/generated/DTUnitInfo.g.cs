...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTUnitInfo : DTEntityInfo, ITypeChecker, IConstrainer, IEquatable<DTUnitInfo>
    {
        ...
        private readonly Dtmi implicitSupplementalTypeId;
        ...
        private List<ValueConstraint> symbolValueConstraints = null;

        private string commentPropertyLayer = null;

        private string symbolPropertyLayer = null;
        ...
        static DTUnitInfo()
        {
            ...
            VersionlessTypes.Add("dtmi:dtdl:class:Unit");
            ...
            BadTypeActionFormat[2] = "Provide a @type{line3} of a subtype of Unit, or provide a value for property '{property}'{line1} with @type of a subtype of Unit.";
            BadTypeActionFormat[3] = "Provide a @type{line3} of a subtype of Unit, or provide a value for property '{property}'{line1} with @type of a subtype of Unit.";
            BadTypeActionFormat[4] = "Provide a @type{line3} of a subtype of Unit, or provide a value for property '{property}'{line1} with @type of a subtype of Unit.";

            BadTypeCauseFormat[2] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that is not a subtype of Unit.";
            BadTypeCauseFormat[3] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that is not a subtype of Unit.";
            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that is not a subtype of Unit.";

            BadTypeLocatedCauseFormat[2] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that is not a subtype of Unit.";
            BadTypeLocatedCauseFormat[3] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that is not a subtype of Unit.";
            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that is not a subtype of Unit.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DTUnitInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the Unit.</param>
        /// <param name="id">Identifier for the Unit.</param>
        /// <param name="childOf">Identifier of the parent element in which this Unit is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Unit.</param>
        /// <param name="definedIn">Identifier of the partition in which this Unit is defined.</param>
        /// <param name="implicitSupplementalTypeId">Identifier for an implicit supplemantal type.</param>
        internal DTUnitInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, Dtmi implicitSupplementalTypeId)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.Unit)
        {
            ...
            this.implicitSupplementalTypeId = implicitSupplementalTypeId;
        ...
        internal DTUnitInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, Dtmi implicitSupplementalTypeId, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type Unit in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type Unit.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:Unit;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// </summary>
        /// <value>The 'symbol' property of the DTDL element.</value>
        ...
        /// <summary>
        /// Determines whether two <c>DTUnitInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTUnitInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTUnitInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTUnitInfo x, DTUnitInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTUnitInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTUnitInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTUnitInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTUnitInfo)other);
        }
        ...
        /// <param name="other">The other <c>DTUnitInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTUnitInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTUnitInfo)other);
        }
        ...
        {
            return otherObj is DTUnitInfo other && this.Equals(other);
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked
            {
                hashCode = (hashCode * 131) + (this.Symbol?.GetHashCode() ?? 0);
        ...
        void IConstrainer.AddPropertyValueConstraint(string propertyName, ValueConstraint valueConstraint)
        {
            switch (propertyName)
            {
                ...
                case "displayName":
                    ...
                    break;
                case "symbol":
                    if (this.symbolValueConstraints == null)
                    {
                        this.symbolValueConstraints = new List<ValueConstraint>();
                    }

                    this.symbolValueConstraints.Add(valueConstraint);
                    break;
            }
        }
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTUnitInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTUnitInfo elementInfo = (DTUnitInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTUnitInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTUnitInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTUnitInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        internal override void ParsePropertiesV2(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, AggregateContext aggregateContext, HashSet<Dtmi> immediateSupplementalTypeIds, List<string> immediateUndefinedTypes, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi definedIn, bool globalize, bool allowReservedIds, bool tolerateSolecisms)
        {
            ...
            JsonLdProperty symbolProperty = null;
                ...
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:symbol;2":
                        ...
                        else
                        {
                            symbolProperty = prop;
                            int? maxLength = null;
                            string newSymbol = ValueParser.ParseSingularStringValueCollection(aggregateContext, this.Id, "symbol", prop.Values, maxLength, null, layer, parsingErrorCollection, isOptional: true);
                            if (this.symbolPropertyLayer != null)
                            {
                                if (this.Symbol != newSymbol)
                                {
                                    JsonLdProperty extantProp = this.JsonLdElements[this.symbolPropertyLayer].Properties.FirstOrDefault(p => p.Name == "symbol");
                                    parsingErrorCollection.Notify(
                                        "inconsistentStringValues",
                                        elementId: this.Id,
                                        propertyName: "symbol",
                                        propertyValue: newSymbol.ToString(),
                                        valueRestriction: this.Symbol.ToString(),
                                        incidentProperty: prop,
                                        extantProperty: extantProp,
                                        layer: layer);
                                }
                            ...
                            else
                            {
                                ...
                                this.symbolPropertyLayer = layer;

                                if (this.symbolValueConstraints != null)
                                {
                                    foreach (ValueConstraint valueConstraint in this.symbolValueConstraints)
                                    {
                                        if (valueConstraint.RequiredLiteral != null && !valueConstraint.RequiredLiteral.Equals(newSymbol))
                                        {
                                            parsingErrorCollection.Notify(
                                                "notRequiredStringValue",
                                                elementId: this.Id,
                                ...
                                ((Dictionary<string, string>)this.StringProperties)["symbol"] = newSymbol;
                            }
                        }
            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:displayName;4":
                        ...
                        continue;
                    case "symbol":
                    case "dtmi:dtdl:property:symbol;4":
                        if (symbolProperty != null)
                        {
                            parsingErrorCollection.Notify(
                                "duplicatePropertyName",
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:Unit;{this.LanguageMajorVersion}");
            }

            jsonWriter.WriteString("symbol", this.Symbol);
        }
