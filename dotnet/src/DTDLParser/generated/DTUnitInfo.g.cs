            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:symbol;2":
                        ...
                        {
                            symbolProperty = prop;
                            string newSymbol = ValueParser.ParseSingularStringValueCollection(aggregateContext, this.Id, "symbol", prop.Values, null, null, layer, parsingErrorCollection, isOptional: true);
