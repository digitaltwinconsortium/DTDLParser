...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public abstract class DTComplexSchemaInfo : DTSchemaInfo, ITypeChecker, IEquatable<DTComplexSchemaInfo>
    {
        ...
        static DTComplexSchemaInfo()
        {
            ...
            BadTypeCauseFormat[2] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Array, Enum, Map, or Object.";
            BadTypeCauseFormat[3] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Array, Enum, Map, or Object.";
            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Array, Enum, Map, or Object.";

            BadTypeLocatedCauseFormat[2] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Array, Enum, Map, or Object.";
            BadTypeLocatedCauseFormat[3] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Array, Enum, Map, or Object.";
            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Array, Enum, Map, or Object.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DTComplexSchemaInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the ComplexSchema.</param>
        /// <param name="id">Identifier for the ComplexSchema.</param>
        /// <param name="childOf">Identifier of the parent element in which this ComplexSchema is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this ComplexSchema.</param>
        ...
        internal DTComplexSchemaInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type ComplexSchema in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type ComplexSchema.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:ComplexSchema;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTComplexSchemaInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTComplexSchemaInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTComplexSchemaInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTComplexSchemaInfo x, DTComplexSchemaInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTComplexSchemaInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTComplexSchemaInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTComplexSchemaInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTComplexSchemaInfo)other);
        }
        ...
        {
            return otherObj is DTComplexSchemaInfo other && this.Equals(other);
        }
        ...
        /// <param name="other">The other <c>DTComplexSchemaInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTComplexSchemaInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTComplexSchemaInfo)other);
        }
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object of type <c>DTComplexSchemaInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTComplexSchemaInfo elementInfo = (DTComplexSchemaInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for a subclass of type <c>DTComplexSchemaInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTComplexSchemaInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of type <c>DTComplexSchemaInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        {
            throw new Exception($"attempt to add type {id} to non-augmentable type DTComplexSchemaInfo");
        }
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:ComplexSchema;{this.LanguageMajorVersion}");
            }
        }
