                ...
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:properties;2":
                        ...
                        else
                        {
                            ...
                            DTPropertyInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.propertiesValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "properties", "name", null, 0, isPlural: true, idRequired: false, typeRequired: true, globalize: globalize, allowReservedIds: allowReservedIds, allowIdReferenceSyntax: allowIdReferenceSyntax, ignoreElementsWithAutoIDsAndDuplicateNames: ignoreElementsWithAutoIDsAndDuplicateNames, allowedVersions: this.propertiesAllowedVersionsV2);
                        }
                    ...
                    case "dtmi:dtdl:property:target;2":
                        ...
                        {
                            targetProperty = prop;
                            Dtmi newTarget = (Dtmi)ValueParser.ParseSingularIdentifierValueCollection(aggregateContext, this.Id, "target", prop.Values, 2048, TargetPropertyRegexPatternV2, layer, parsingErrorCollection, isOptional: true, requireDtmi: true);
            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:properties;3":
                        ...
                        {
                            propertiesProperty = prop;
                            DTPropertyInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.propertiesValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "properties", "name", null, 0, isPlural: true, idRequired: false, typeRequired: true, globalize: globalize, allowReservedIds: allowReservedIds, allowIdReferenceSyntax: allowIdReferenceSyntax, ignoreElementsWithAutoIDsAndDuplicateNames: ignoreElementsWithAutoIDsAndDuplicateNames, allowedVersions: this.propertiesAllowedVersionsV3);
                        }
                    ...
                    case "dtmi:dtdl:property:target;3":
                        ...
                        {
                            targetProperty = prop;
                            Dtmi newTarget = (Dtmi)ValueParser.ParseSingularIdentifierValueCollection(aggregateContext, this.Id, "target", prop.Values, 2048, TargetPropertyRegexPatternV3, layer, parsingErrorCollection, isOptional: true, requireDtmi: true);
                            if (this.targetPropertyLayer != null)
                            {
                                if (this.Target != newTarget)
                                {
