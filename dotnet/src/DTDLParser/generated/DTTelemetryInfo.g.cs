...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTTelemetryInfo : DTContentInfo, ITypeChecker, IConstrainer, IPropertyInstanceBinder, IEquatable<DTTelemetryInfo>
    {
        ...
        static DTTelemetryInfo()
        {
            ...
            VersionlessTypes.Add("dtmi:dtdl:class:Telemetry");
            ...
            BadTypeActionFormat[2] = "Provide a @type{line3} of Telemetry, or provide a value for property '{property}'{line1} with @type of Telemetry.";
            BadTypeActionFormat[3] = "Provide a @type{line3} of Telemetry, or provide a value for property '{property}'{line1} with @type of Telemetry.";
            BadTypeActionFormat[4] = "Provide a @type{line3} of Telemetry, or provide a value for property '{property}'{line1} with @type of Telemetry.";

            BadTypeCauseFormat[2] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Telemetry.";
            BadTypeCauseFormat[3] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Telemetry.";
            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Telemetry.";

            BadTypeLocatedCauseFormat[2] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Telemetry.";
            BadTypeLocatedCauseFormat[3] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Telemetry.";
            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Telemetry.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DTTelemetryInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the Telemetry.</param>
        /// <param name="id">Identifier for the Telemetry.</param>
        /// <param name="childOf">Identifier of the parent element in which this Telemetry is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Telemetry.</param>
        /// <param name="definedIn">Identifier of the partition in which this Telemetry is defined.</param>
        internal DTTelemetryInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.Telemetry)
        {
            this.Schema = null;
        ...
        internal DTTelemetryInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type Telemetry in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type Telemetry.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:Telemetry;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTTelemetryInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTTelemetryInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTTelemetryInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTTelemetryInfo x, DTTelemetryInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTTelemetryInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTTelemetryInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTTelemetryInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTTelemetryInfo)other);
        }
        ...
        /// <param name="other">The other <c>DTTelemetryInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTTelemetryInfo other)
        {
        ...
        {
            return otherObj is DTTelemetryInfo other && this.Equals(other);
        }

        /// <inheritdoc/>
        public override bool Equals(DTNamedEntityInfo other)
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTTelemetryInfo)other);
        }
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTTelemetryInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTTelemetryInfo elementInfo = (DTTelemetryInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTTelemetryInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTTelemetryInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTTelemetryInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:Telemetry;{this.LanguageMajorVersion}");
            }
