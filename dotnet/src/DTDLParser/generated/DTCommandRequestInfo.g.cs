...
namespace DTDLParser.Models
{
    ...
    /// <summary>
    /// Class <c>DTCommandRequestInfo</c> corresponds to an element of type CommandRequest in a DTDL model.
    /// </summary>
    public class DTCommandRequestInfo : DTCommandPayloadInfo, ITypeChecker, IConstrainer, IPropertyInstanceBinder, IEquatable<DTCommandRequestInfo>
    {
        ...
        static DTCommandRequestInfo()
        {
            VersionlessTypes.Add("dtmi:dtdl:class:CommandPayload");
            VersionlessTypes.Add("dtmi:dtdl:class:CommandRequest");
            ...
            BadTypeActionFormat[3] = "Provide a @type{line3} of CommandRequest, or provide a value for property '{property}'{line1} with @type of CommandRequest.";
            BadTypeActionFormat[4] = "Provide a @type{line3} of CommandRequest, or provide a value for property '{property}'{line1} with @type of CommandRequest.";

            BadTypeCauseFormat[3] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of CommandRequest.";
            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of CommandRequest.";

            BadTypeLocatedCauseFormat[3] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of CommandRequest.";
            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of CommandRequest.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DTCommandRequestInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the CommandRequest.</param>
        /// <param name="id">Identifier for the CommandRequest.</param>
        /// <param name="childOf">Identifier of the parent element in which this CommandRequest is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this CommandRequest.</param>
        /// <param name="definedIn">Identifier of the partition in which this CommandRequest is defined.</param>
        internal DTCommandRequestInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.CommandRequest)
        {
        ...
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this CommandRequest.</param>
        /// <param name="definedIn">Identifier of the partition in which this CommandRequest is defined.</param>
        /// <param name="entityKind">The kind of Entity, which may be other than CommandRequest if this constructor is called from a derived class.</param>
        internal DTCommandRequestInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type CommandRequest in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type CommandRequest.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:CommandRequest;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTCommandRequestInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTCommandRequestInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTCommandRequestInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTCommandRequestInfo x, DTCommandRequestInfo y)
        {
        ...
        /// <summary>
        /// Determines whether two <c>DTCommandRequestInfo</c> objects are equal.
        /// </summary>
        /// <param name="x">One <c>DTCommandRequestInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTCommandRequestInfo</c> object to compare to the first.</param>
        ...
        /// <summary>
        /// Compares to another <c>DTCommandRequestInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTCommandRequestInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTCommandRequestInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTCommandRequestInfo)other);
        }
        ...
        /// <summary>
        /// Compares to another <c>DTCommandRequestInfo</c> object.
        /// </summary>
        /// <param name="other">The other <c>DTCommandRequestInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTCommandRequestInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTCommandRequestInfo)other);
        }
        ...
        {
            return otherObj is DTCommandRequestInfo other && this.Equals(other);
        }
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTCommandRequestInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTCommandRequestInfo elementInfo = (DTCommandRequestInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTCommandRequestInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTCommandRequestInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTCommandRequestInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        /// <summary>
        /// Parse the properties in a JSON CommandRequest object.
        /// </summary>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:CommandRequest;{this.LanguageMajorVersion}");
            }
        }
