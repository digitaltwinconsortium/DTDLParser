...
namespace DTDLParser.Models
{
    ...
    /// <summary>
    /// Class <c>DTUuidInfo</c> corresponds to an element of type Uuid in a DTDL model.
    /// </summary>
    public class DTUuidInfo : DTPrimitiveSchemaInfo, ITypeChecker, IConstrainer, IEquatable<DTUuidInfo>
    {
        ...
        private static readonly Regex ElementValueInstanceRegexPatternV4 = new Regex(@"^[0-9a-fA-F]{8}-(?:[0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}$", RegexOptions.Compiled);
        ...
        static DTUuidInfo()
        {
            ...
            VersionlessTypes.Add("dtmi:dtdl:class:Uuid");
            ...
            BadTypeActionFormat[4] = "Use this standard value for property '{property}'{line1}: uuid.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DTUuidInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the Uuid.</param>
        /// <param name="id">Identifier for the Uuid.</param>
        /// <param name="childOf">Identifier of the parent element in which this Uuid is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Uuid.</param>
        /// <param name="definedIn">Identifier of the partition in which this Uuid is defined.</param>
        internal DTUuidInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.Uuid)
        {
        ...
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Uuid.</param>
        /// <param name="definedIn">Identifier of the partition in which this Uuid is defined.</param>
        /// <param name="entityKind">The kind of Entity, which may be other than Uuid if this constructor is called from a derived class.</param>
        internal DTUuidInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type Uuid in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type Uuid.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:Uuid;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTUuidInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTUuidInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTUuidInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTUuidInfo x, DTUuidInfo y)
        {
        ...
        /// <summary>
        /// Determines whether two <c>DTUuidInfo</c> objects are equal.
        /// </summary>
        /// <param name="x">One <c>DTUuidInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTUuidInfo</c> object to compare to the first.</param>
        ...
        /// <summary>
        /// Compares to another <c>DTUuidInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTUuidInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTUuidInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTUuidInfo)other);
        }
        ...
        {
            return otherObj is DTUuidInfo other && this.Equals(other);
        }

        /// <summary>
        /// Compares to another <c>DTUuidInfo</c> object.
        /// </summary>
        /// <param name="other">The other <c>DTUuidInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTUuidInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTUuidInfo)other);
        }
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTUuidInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTUuidInfo elementInfo = (DTUuidInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTUuidInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTUuidInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTUuidInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        /// <summary>
        /// Parse the properties in a JSON Uuid object.
        /// </summary>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:Uuid;{this.LanguageMajorVersion}");
            }
        }
