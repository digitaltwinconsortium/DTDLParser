...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTMapKeyInfo : DTNamedEntityInfo, ITypeChecker, IConstrainer, IPropertyInstanceBinder, IEquatable<DTMapKeyInfo>
    {
        ...
        private HashSet<int> schemaAllowedVersionsV4 = new HashSet<int>() { 4, 3, 2 };
        ...
        static DTMapKeyInfo()
        {
            ...
            VersionlessTypes.Add("dtmi:dtdl:class:MapKey");
            ...
            BadTypeActionFormat[2] = "Provide a @type{line3} of MapKey, or provide a value for property '{property}'{line1} with @type of MapKey.";
            BadTypeActionFormat[3] = "Provide a @type{line3} of MapKey, or provide a value for property '{property}'{line1} with @type of MapKey.";
            BadTypeActionFormat[4] = "Provide a @type{line3} of MapKey, or provide a value for property '{property}'{line1} with @type of MapKey.";

            BadTypeCauseFormat[2] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of MapKey.";
            BadTypeCauseFormat[3] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of MapKey.";
            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of MapKey.";

            BadTypeLocatedCauseFormat[2] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of MapKey.";
            BadTypeLocatedCauseFormat[3] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of MapKey.";
            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of MapKey.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DTMapKeyInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the MapKey.</param>
        /// <param name="id">Identifier for the MapKey.</param>
        /// <param name="childOf">Identifier of the parent element in which this MapKey is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this MapKey.</param>
        /// <param name="definedIn">Identifier of the partition in which this MapKey is defined.</param>
        internal DTMapKeyInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.MapKey)
        {
            this.Schema = null;
        ...
        internal DTMapKeyInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type MapKey in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type MapKey.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:MapKey;{this.LanguageMajorVersion}");
            }
        }
        ...
        public DTStringInfo Schema { get; internal set; }
        ...
        /// <summary>
        /// Determines whether two <c>DTMapKeyInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTMapKeyInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTMapKeyInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTMapKeyInfo x, DTMapKeyInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTMapKeyInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTMapKeyInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTMapKeyInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTMapKeyInfo)other);
        }
        ...
        /// <param name="other">The other <c>DTMapKeyInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTMapKeyInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTMapKeyInfo)other);
        }
        ...
        {
            return otherObj is DTMapKeyInfo other && this.Equals(other);
        }
        ...
        void IConstrainer.AddPropertyValueConstraint(string propertyName, ValueConstraint valueConstraint)
        {
            switch (propertyName)
            {
                ...
                case "schema":
                    ...
                    {
                        this.schemaValueConstraints = new List<ValueConstraint>();
                    }

                    this.schemaValueConstraints.Add(valueConstraint);
                    break;
            }
        }
        ...
        void IPropertyInstanceBinder.AddInstanceProperty(string propertyName, string instancePropertyName)
        {
            ...
            {
                case "schema":
                    if (this.schemaInstanceProperties == null)
                    {
                        this.schemaInstanceProperties = new List<string>();
                    }

                    this.schemaInstanceProperties.Add(instancePropertyName);
                    break;
            }
        }

        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTMapKeyInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTMapKeyInfo elementInfo = (DTMapKeyInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTMapKeyInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTMapKeyInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTMapKeyInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        internal override bool CheckDepthOfElementSchemaOrSchema(int depth, int depthLimit, bool allowSelf, List<Dtmi> tooDeepElementIds, out Dictionary<string, JsonLdElement> tooDeepElts, ParsingErrorCollection parsingErrorCollection)
        {
            ...
            if (this.Schema != null)
            {
                if (!this.Schema.CheckDepthOfElementSchemaOrSchema(depth + 1, depthLimit, allowSelf, tooDeepElementIds, out tooDeepElts, parsingErrorCollection))
                {
        ...
        internal override bool TryGetDescendantSchemaArray(out Dtmi elementId, out Dictionary<string, JsonLdElement> excludedElts)
        {
            ...
            if (this.Schema != null)
            {
                if (this.Schema.EntityKind == DTEntityKind.Array)
                {
                    elementId = this.Schema.Id;
                    excludedElts = this.Schema.JsonLdElements;
                    this.idOfDescendantSchemaArray = elementId;
                    this.eltsOfDescendantSchemaArray = excludedElts;
                    return true;
                }

                if (this.Schema.TryGetDescendantSchemaArray(out elementId, out excludedElts))
                {
                    this.idOfDescendantSchemaArray = elementId;
                    this.eltsOfDescendantSchemaArray = excludedElts;
                    return true;
        ...
        internal override bool TryGetDescendantSchemaOrContentsComponentNarrow(out Dtmi elementId, out Dictionary<string, JsonLdElement> excludedElts)
        {
            ...
            if (this.Schema != null)
            {
                if (this.Schema.EntityKind == DTEntityKind.Component)
                {
                    elementId = this.Schema.Id;
                    excludedElts = this.Schema.JsonLdElements;
                ...
                if (this.Schema.TryGetDescendantSchemaOrContentsComponentNarrow(out elementId, out excludedElts))
                {
                    this.idOfDescendantSchemaOrContentsComponentNarrow = elementId;
                    this.eltsOfDescendantSchemaOrContentsComponentNarrow = excludedElts;
                    return true;
        ...
        internal override bool TrySetObjectProperty(string propertyName, string layer, JsonLdProperty propProp, DTEntityInfo element, string keyProp, string keyValue, ParsingErrorCollection parsingErrorCollection)
        {
            ...
            switch (propertyName)
            {
                ...
                case "dtmi:dtdl:property:schema;4":
                    ...
                    {
                        this.Schema = (DTStringInfo)element;
        ...
        internal override int GetCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(bool allowSelf, ParsingErrorCollection parsingErrorCollection)
        {
            ...
            if (this.Schema != null)
            {
                this.countOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrowValue += this.Schema.GetCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(allowSelf, parsingErrorCollection) + 1;
            }
        ...
        internal override void CheckDescendantEnumValueDatatype(Dtmi ancestorId, Dictionary<string, JsonLdElement> ancestorElts, Type datatype, ParsingErrorCollection parsingErrorCollection)
        {
            if (this.checkedDescendantEnumValueDatatype != datatype)
            {
                ...
                if (this.Schema != null)
                {
                    this.Schema.CheckDescendantEnumValueDatatype(ancestorId, ancestorElts, datatype, parsingErrorCollection);
                }
            }
        }
            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:schema;2":
                        ...
                        {
                            schemaProperty = prop;
                            DTStringInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.schemaValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "schema", null, null, 1, isPlural: false, idRequired: true, typeRequired: true, globalize: globalize, allowReservedIds: allowReservedIds, tolerateSolecisms: tolerateSolecisms, allowedVersions: this.schemaAllowedVersionsV2);
                        }
            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:schema;3":
                        ...
                        {
                            schemaProperty = prop;
                            DTStringInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.schemaValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "schema", null, null, 1, isPlural: false, idRequired: true, typeRequired: true, globalize: globalize, allowReservedIds: allowReservedIds, tolerateSolecisms: tolerateSolecisms, allowedVersions: this.schemaAllowedVersionsV3);
                        }
            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:schema;4":
                        ...
                        {
                            schemaProperty = prop;
                            DTStringInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.schemaValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "schema", null, null, 1, isPlural: false, idRequired: true, typeRequired: true, globalize: globalize, allowReservedIds: allowReservedIds, tolerateSolecisms: tolerateSolecisms, allowedVersions: this.schemaAllowedVersionsV4);
                        }
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:MapKey;{this.LanguageMajorVersion}");
            }
        ...
        {
            if (this.Schema != null && this.Schema.Id.AbsoluteUri != "dtmi:dtdl:instance:Schema:string;2")
            {
                JsonLdProperty propProp = this.JsonLdElements.FirstOrDefault(e => e.Value.Properties.Any(p => p.Name == "schema")).Value?.Properties?.First();
                parsingErrorCollection.Notify(
                    "incorrectPropertyValue",
                    elementId: this.Id,
                    propertyName: "schema",
                    propertyValue: ContextCollection.GetTermOrUri(this.Schema.Id),
            ...
            if (this.schemaInstanceProperties != null)
            {
                foreach (string instanceProp in this.schemaInstanceProperties)
                {
                    if (this.supplementalProperties.TryGetValue(instanceProp, out object supplementalProperty))
                    {
                        IReadOnlyCollection<string> violations = supplementalProperty is JsonElement jsonElement ? this.Schema.ValidateInstance(jsonElement) : this.Schema.ValidateInstance(supplementalProperty.ToString());
                        if (violations.Any())
                        {
                            ...
                            JsonLdProperty conformanceProp = this.JsonLdElements.FirstOrDefault(e => e.Value.Properties.Any(p => p.Name == "schema")).Value?.Properties?.First(p => p.Name == "schema");

                            parsingErrorCollection.Notify(
                                "nonConformantPropertyValue",
                                elementId: this.Id,
                                propertyName: instanceTerm,
                                governingPropertyName: "schema",
        ...
        {
            if (this.Schema != null && this.Schema.Id.AbsoluteUri != "dtmi:dtdl:instance:Schema:string;3" && this.Schema.Id.AbsoluteUri != "dtmi:dtdl:instance:Schema:string;2")
            {
                JsonLdProperty propProp = this.JsonLdElements.FirstOrDefault(e => e.Value.Properties.Any(p => p.Name == "schema")).Value?.Properties?.First();
                parsingErrorCollection.Notify(
                    "incorrectPropertyValue",
        ...
        {
            if (this.Schema != null && this.Schema.Id.AbsoluteUri != "dtmi:dtdl:instance:Schema:string;4" && this.Schema.Id.AbsoluteUri != "dtmi:dtdl:instance:Schema:string;3" && this.Schema.Id.AbsoluteUri != "dtmi:dtdl:instance:Schema:string;2")
            {
                JsonLdProperty propProp = this.JsonLdElements.FirstOrDefault(e => e.Value.Properties.Any(p => p.Name == "schema")).Value?.Properties?.First();
                parsingErrorCollection.Notify(
                    "incorrectPropertyValue",
