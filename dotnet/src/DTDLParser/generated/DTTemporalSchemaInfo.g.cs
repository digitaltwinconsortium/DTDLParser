...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public abstract class DTTemporalSchemaInfo : DTPrimitiveSchemaInfo, ITypeChecker, IEquatable<DTTemporalSchemaInfo>
    {
        ...
        static DTTemporalSchemaInfo()
        {
            ...
            BadTypeActionFormat[2] = "Use one of these standard values for property '{property}'{line1}: date, dateTime, duration, time.";
            BadTypeActionFormat[3] = "Use one of these standard values for property '{property}'{line1}: date, dateTime, duration, time.";
            BadTypeActionFormat[4] = "Use one of these standard values for property '{property}'{line1}: date, dateTime, duration, time.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DTTemporalSchemaInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the TemporalSchema.</param>
        /// <param name="id">Identifier for the TemporalSchema.</param>
        /// <param name="childOf">Identifier of the parent element in which this TemporalSchema is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this TemporalSchema.</param>
        ...
        internal DTTemporalSchemaInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type TemporalSchema in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type TemporalSchema.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:TemporalSchema;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTTemporalSchemaInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTTemporalSchemaInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTTemporalSchemaInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTTemporalSchemaInfo x, DTTemporalSchemaInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTTemporalSchemaInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTTemporalSchemaInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTTemporalSchemaInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTTemporalSchemaInfo)other);
        }
        ...
        {
            return otherObj is DTTemporalSchemaInfo other && this.Equals(other);
        }
        ...
        /// <param name="other">The other <c>DTTemporalSchemaInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTTemporalSchemaInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTTemporalSchemaInfo)other);
        }
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object of type <c>DTTemporalSchemaInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTTemporalSchemaInfo elementInfo = (DTTemporalSchemaInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for a subclass of type <c>DTTemporalSchemaInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTTemporalSchemaInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of type <c>DTTemporalSchemaInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        {
            throw new Exception($"attempt to add type {id} to non-augmentable type DTTemporalSchemaInfo");
        }
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:TemporalSchema;{this.LanguageMajorVersion}");
            }
        }
