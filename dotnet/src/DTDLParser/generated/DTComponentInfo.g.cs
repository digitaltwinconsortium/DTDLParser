...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTComponentInfo : DTContentInfo, ITypeChecker, IConstrainer, IPropertyInstanceBinder, IEquatable<DTComponentInfo>
    {
        ...
        static DTComponentInfo()
        {
            VersionlessTypes.Add("dtmi:dtdl:class:Component");
            ...
            BadTypeActionFormat[2] = "Provide a @type{line3} of Component, or provide a value for property '{property}'{line1} with @type of Component.";
            BadTypeActionFormat[3] = "Provide a @type{line3} of Component, or provide a value for property '{property}'{line1} with @type of Component.";
            BadTypeActionFormat[4] = "Provide a @type{line3} of Component, or provide a value for property '{property}'{line1} with @type of Component.";

            BadTypeCauseFormat[2] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Component.";
            BadTypeCauseFormat[3] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Component.";
            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Component.";

            BadTypeLocatedCauseFormat[2] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Component.";
            BadTypeLocatedCauseFormat[3] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Component.";
            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Component.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DTComponentInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the Component.</param>
        /// <param name="id">Identifier for the Component.</param>
        /// <param name="childOf">Identifier of the parent element in which this Component is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Component.</param>
        /// <param name="definedIn">Identifier of the partition in which this Component is defined.</param>
        internal DTComponentInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.Component)
        {
            this.Schema = null;
        ...
        internal DTComponentInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        public DTInterfaceInfo Schema { get; internal set; }

        /// <summary>
        /// Get the DTMI that identifies type Component in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type Component.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:Component;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTComponentInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTComponentInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTComponentInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTComponentInfo x, DTComponentInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTComponentInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTComponentInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTComponentInfo other)
        {
        ...
        /// <param name="other">The other <c>DTComponentInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTComponentInfo other)
        {
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTComponentInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTComponentInfo elementInfo = (DTComponentInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTComponentInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTComponentInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTComponentInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        internal override bool TrySetObjectProperty(string propertyName, string layer, JsonLdProperty propProp, DTEntityInfo element, string keyProp, string keyValue, ParsingErrorCollection parsingErrorCollection)
        {
            ...
            switch (propertyName)
            {
                ...
                case "dtmi:dtdl:property:schema;4":
                    ...
                    {
                        this.Schema = (DTInterfaceInfo)element;
        ...
        private void CheckRestrictionsV2(ParsingErrorCollection parsingErrorCollection)
        {
            ...
            if (this.TryGetDescendantSchemaOrContentsComponentNarrow(out Dtmi excludedComponentElementId, out Dictionary<string, JsonLdElement> excludedComponentElts))
            {
                JsonLdElement ancestorElt = this.JsonLdElements.FirstOrDefault(e => e.Value.Properties.Any(p => p.Name == "schema" || p.Name == "contents")).Value;
                JsonLdElement descendantElt = excludedComponentElts.FirstOrDefault(e => e.Value.Types.Contains("Component")).Value;

                parsingErrorCollection.Notify(
                    "excludedType",
                    elementId: this.Id,
                    propertyDisjunction: "'schema' or 'contents'",
                    referenceId: excludedComponentElementId,
                    referenceType: "Component",
