...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTTimeInfo : DTTemporalSchemaInfo, ITypeChecker, IConstrainer, IEquatable<DTTimeInfo>
    {
        ...
        private static readonly Regex ElementValueInstanceRegexPatternV2 = new Regex(@"^[0-9]{2}:[0-9]{2}:[0-9]{2}(?:\.[0-9]+)?(?:Z|(?:\+|\-)[0-9]{2}:[0-9]{2})$", RegexOptions.Compiled);

        private static readonly Regex ElementValueInstanceRegexPatternV3 = new Regex(@"^[0-9]{2}:[0-9]{2}:[0-9]{2}(?:\.[0-9]+)?(?:Z|(?:\+|\-)[0-9]{2}:[0-9]{2})$", RegexOptions.Compiled);

        private static readonly Regex ElementValueInstanceRegexPatternV4 = new Regex(@"^[0-9]{2}:[0-9]{2}:[0-9]{2}(?:\.[0-9]+)?(?:Z|(?:\+|\-)[0-9]{2}:[0-9]{2})$", RegexOptions.Compiled);
        ...
        static DTTimeInfo()
        {
            ...
            VersionlessTypes.Add("dtmi:dtdl:class:Time");
            ...
            BadTypeActionFormat[2] = "Use this standard value for property '{property}'{line1}: time.";
            BadTypeActionFormat[3] = "Use this standard value for property '{property}'{line1}: time.";
            BadTypeActionFormat[4] = "Use this standard value for property '{property}'{line1}: time.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DTTimeInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the Time.</param>
        /// <param name="id">Identifier for the Time.</param>
        /// <param name="childOf">Identifier of the parent element in which this Time is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Time.</param>
        /// <param name="definedIn">Identifier of the partition in which this Time is defined.</param>
        internal DTTimeInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.Time)
        {
        ...
        internal DTTimeInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type Time in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type Time.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:Time;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTTimeInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTTimeInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTTimeInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTTimeInfo x, DTTimeInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTTimeInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTTimeInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTTimeInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTTimeInfo)other);
        }
        ...
        /// <param name="other">The other <c>DTTimeInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTTimeInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTTimeInfo)other);
        }
        ...
        {
            return otherObj is DTTimeInfo other && this.Equals(other);
        }
        ...
        /// <summary>
        /// Validate a <c>JsonElement</c> to determine whether it is a string value that conforms to the RFC 3339 definition of 'time'.
        /// </summary>
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTTimeInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTTimeInfo elementInfo = (DTTimeInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTTimeInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTTimeInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTTimeInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:Time;{this.LanguageMajorVersion}");
            }
        }
        ...
        private bool ValidateInstanceV2(JsonElement instanceElt, string instanceName, List<string> violations)
        {
            ...
            {
                violations.Add($"\"{instanceElt.GetString()}\" does not conform to the RFC 3339 definition of 'time'");
                return false;
            }
