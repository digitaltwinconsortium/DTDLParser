...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTBooleanInfo : DTPrimitiveSchemaInfo, ITypeChecker, IConstrainer, IEquatable<DTBooleanInfo>
    {
        ...
        static DTBooleanInfo()
        {
            VersionlessTypes.Add("dtmi:dtdl:class:Boolean");
            ...
            BadTypeActionFormat[2] = "Use this standard value for property '{property}'{line1}: boolean.";
            BadTypeActionFormat[3] = "Use this standard value for property '{property}'{line1}: boolean.";
            BadTypeActionFormat[4] = "Use this standard value for property '{property}'{line1}: boolean.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DTBooleanInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the Boolean.</param>
        /// <param name="id">Identifier for the Boolean.</param>
        /// <param name="childOf">Identifier of the parent element in which this Boolean is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Boolean.</param>
        /// <param name="definedIn">Identifier of the partition in which this Boolean is defined.</param>
        internal DTBooleanInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.Boolean)
        {
        ...
        internal DTBooleanInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type Boolean in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type Boolean.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:Boolean;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTBooleanInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTBooleanInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTBooleanInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTBooleanInfo x, DTBooleanInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTBooleanInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTBooleanInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTBooleanInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTBooleanInfo)other);
        }
        ...
        {
            return otherObj is DTBooleanInfo other && this.Equals(other);
        }
        ...
        /// <param name="other">The other <c>DTBooleanInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTBooleanInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTBooleanInfo)other);
        }
        ...
        /// <summary>
        /// Validate a <c>JsonElement</c> to determine whether it is a boolean value.
        /// </summary>
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTBooleanInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTBooleanInfo elementInfo = (DTBooleanInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTBooleanInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTBooleanInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTBooleanInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:Boolean;{this.LanguageMajorVersion}");
            }
        }
        ...
        {
            if (instanceElt.ValueKind != JsonValueKind.True && instanceElt.ValueKind != JsonValueKind.False)
            {
                violations.Add($">>{instanceElt.GetRawText()}<< is not a boolean value");
                return false;
            }
