...
namespace DTDLParser.Models
{
    ...
    /// <summary>
    /// Class <c>DTShortInfo</c> corresponds to an element of type Short in a DTDL model.
    /// </summary>
    public class DTShortInfo : DTNumericSchemaInfo, ITypeChecker, IConstrainer, IEquatable<DTShortInfo>
    {
        ...
        static DTShortInfo()
        {
            ...
            VersionlessTypes.Add("dtmi:dtdl:class:Short");
            ...
            BadTypeActionFormat[4] = "Use this standard value for property '{property}'{line1}: short.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DTShortInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the Short.</param>
        /// <param name="id">Identifier for the Short.</param>
        /// <param name="childOf">Identifier of the parent element in which this Short is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Short.</param>
        /// <param name="definedIn">Identifier of the partition in which this Short is defined.</param>
        internal DTShortInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.Short)
        {
        ...
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Short.</param>
        /// <param name="definedIn">Identifier of the partition in which this Short is defined.</param>
        /// <param name="entityKind">The kind of Entity, which may be other than Short if this constructor is called from a derived class.</param>
        internal DTShortInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type Short in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type Short.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:Short;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTShortInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTShortInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTShortInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTShortInfo x, DTShortInfo y)
        {
        ...
        /// <summary>
        /// Determines whether two <c>DTShortInfo</c> objects are equal.
        /// </summary>
        /// <param name="x">One <c>DTShortInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTShortInfo</c> object to compare to the first.</param>
        ...
        /// <summary>
        /// Compares to another <c>DTShortInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTShortInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTShortInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTShortInfo)other);
        }
        ...
        /// <summary>
        /// Compares to another <c>DTShortInfo</c> object.
        /// </summary>
        /// <param name="other">The other <c>DTShortInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTShortInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTShortInfo)other);
        }
        ...
        {
            return otherObj is DTShortInfo other && this.Equals(other);
        }
        ...
        /// <summary>
        /// Validate a <c>JsonElement</c> to determine whether it is a numeric value that conforms to the XSD definition of 'short'.
        /// </summary>
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTShortInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTShortInfo elementInfo = (DTShortInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTShortInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTShortInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTShortInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        /// <summary>
        /// Parse the properties in a JSON Short object.
        /// </summary>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:Short;{this.LanguageMajorVersion}");
            }
        }
        ...
        private bool ValidateInstanceV4(JsonElement instanceElt, string instanceName, List<string> violations)
        {
            ...
            if (!short.TryParse(instanceElt.GetRawText(), out short _))
            {
                violations.Add($"{instanceElt.GetRawText()} does not conform to the XSD definition of 'short'");
                return false;
            }
