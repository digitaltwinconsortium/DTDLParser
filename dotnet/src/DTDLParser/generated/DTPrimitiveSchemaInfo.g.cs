...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public abstract class DTPrimitiveSchemaInfo : DTSchemaInfo, ITypeChecker, IEquatable<DTPrimitiveSchemaInfo>
    {
        ...
        static DTPrimitiveSchemaInfo()
        {
            ...
            BadTypeActionFormat[4] = "Use one of these standard values for property '{property}'{line1}: boolean, date, dateTime, double, duration, float, integer, long, string, time.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DTPrimitiveSchemaInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the PrimitiveSchema.</param>
        /// <param name="id">Identifier for the PrimitiveSchema.</param>
        /// <param name="childOf">Identifier of the parent element in which this PrimitiveSchema is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this PrimitiveSchema.</param>
        ...
        internal DTPrimitiveSchemaInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type PrimitiveSchema in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type PrimitiveSchema.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:PrimitiveSchema;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTPrimitiveSchemaInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTPrimitiveSchemaInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTPrimitiveSchemaInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTPrimitiveSchemaInfo x, DTPrimitiveSchemaInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTPrimitiveSchemaInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTPrimitiveSchemaInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTPrimitiveSchemaInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTPrimitiveSchemaInfo)other);
        }
        ...
        {
            return otherObj is DTPrimitiveSchemaInfo other && this.Equals(other);
        }
        ...
        /// <param name="other">The other <c>DTPrimitiveSchemaInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTPrimitiveSchemaInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTPrimitiveSchemaInfo)other);
        }
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object of type <c>DTPrimitiveSchemaInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTPrimitiveSchemaInfo elementInfo = (DTPrimitiveSchemaInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for a subclass of type <c>DTPrimitiveSchemaInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTPrimitiveSchemaInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of type <c>DTPrimitiveSchemaInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        {
            throw new Exception($"attempt to add type {id} to non-augmentable type DTPrimitiveSchemaInfo");
        }
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:PrimitiveSchema;{this.LanguageMajorVersion}");
            }
        }
