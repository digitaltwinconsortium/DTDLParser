...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTIntegerInfo : DTNumericSchemaInfo, ITypeChecker, IConstrainer, IEquatable<DTIntegerInfo>
    {
        ...
        static DTIntegerInfo()
        {
            VersionlessTypes.Add("dtmi:dtdl:class:Entity");
            VersionlessTypes.Add("dtmi:dtdl:class:Integer");
            ...
            BadTypeActionFormat[2] = "Use this standard value for property '{property}'{line1}: integer.";
            BadTypeActionFormat[3] = "Use this standard value for property '{property}'{line1}: integer.";
            BadTypeActionFormat[4] = "Use this standard value for property '{property}'{line1}: integer.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DTIntegerInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the Integer.</param>
        /// <param name="id">Identifier for the Integer.</param>
        /// <param name="childOf">Identifier of the parent element in which this Integer is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Integer.</param>
        /// <param name="definedIn">Identifier of the partition in which this Integer is defined.</param>
        internal DTIntegerInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.Integer)
        {
        ...
        internal DTIntegerInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type Integer in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type Integer.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:Integer;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTIntegerInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTIntegerInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTIntegerInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTIntegerInfo x, DTIntegerInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTIntegerInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTIntegerInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTIntegerInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTIntegerInfo)other);
        }
        ...
        /// <param name="other">The other <c>DTIntegerInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTIntegerInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTIntegerInfo)other);
        }
        ...
        {
            return otherObj is DTIntegerInfo other && this.Equals(other);
        }
        ...
        /// <summary>
        /// Validate a <c>JsonElement</c> to determine whether it is a numeric value that conforms to the XSD definition of 'int'.
        /// </summary>
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTIntegerInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTIntegerInfo elementInfo = (DTIntegerInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTIntegerInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTIntegerInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTIntegerInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:Integer;{this.LanguageMajorVersion}");
            }
        }
        ...
        private bool ValidateInstanceV2(JsonElement instanceElt, string instanceName, List<string> violations)
        {
            ...
            if (!int.TryParse(instanceElt.GetRawText(), out int _))
            {
                violations.Add($"{instanceElt.GetRawText()} does not conform to the XSD definition of 'int'");
                return false;
            }
