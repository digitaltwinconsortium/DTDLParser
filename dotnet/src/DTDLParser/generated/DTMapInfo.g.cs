...
namespace DTDLParser.Models
{
    ...
    public class DTMapInfo : DTComplexSchemaInfo, ITypeChecker, IConstrainer, IPropertyInstanceBinder, IEquatable<DTMapInfo>
    {
        ...
        public override int GetHashCode()
        {
            ...
            unchecked
            {
                hashCode = (hashCode * 131) + (ReferenceEquals(null, this.MapKey) ? 0 : this.MapKey.GetHashCode());
                hashCode = (hashCode * 131) + (ReferenceEquals(null, this.MapValue) ? 0 : this.MapValue.GetHashCode());
        ...
        internal override bool CheckDepthOfElementSchemaOrSchema(int depth, int depthLimit, out Dtmi tooDeepElementId, out Dictionary<string, JsonLdElement> tooDeepElts, ParsingErrorCollection parsingErrorCollection)
        {
            if (this.MapKey != null)
            {
                if (!this.MapKey.CheckDepthOfElementSchemaOrSchema(depth, depthLimit, out tooDeepElementId, out tooDeepElts, parsingErrorCollection))
                {
            ...
            {
                if (!this.MapValue.CheckDepthOfElementSchemaOrSchema(depth, depthLimit, out tooDeepElementId, out tooDeepElts, parsingErrorCollection))
                {
                    if (tooDeepElementId == this.Id)
                    {
                        parsingErrorCollection.Notify(
        ...
        internal override int GetCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(ParsingErrorCollection parsingErrorCollection)
        {
            ...
            if (this.MapValue != null)
            {
                this.countOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrowValue += this.MapValue.GetCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(parsingErrorCollection) + 1;
            }
