...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTMapInfo : DTComplexSchemaInfo, ITypeChecker, IConstrainer, IPropertyInstanceBinder, IEquatable<DTMapInfo>
    {
        ...
        private HashSet<int> mapKeyAllowedVersionsV2 = new HashSet<int>() { 2 };

        private HashSet<int> mapKeyAllowedVersionsV3 = new HashSet<int>() { 3 };

        private HashSet<int> mapKeyAllowedVersionsV4 = new HashSet<int>() { 4 };

        private HashSet<int> mapValueAllowedVersionsV2 = new HashSet<int>() { 2 };

        private HashSet<int> mapValueAllowedVersionsV3 = new HashSet<int>() { 3 };

        private HashSet<int> mapValueAllowedVersionsV4 = new HashSet<int>() { 4 };
        ...
        private List<ValueConstraint> mapKeyValueConstraints = null;

        private List<ValueConstraint> mapValueValueConstraints = null;

        private string commentPropertyLayer = null;

        private string mapKeyPropertyLayer = null;

        private string mapValuePropertyLayer = null;
        ...
        static DTMapInfo()
        {
            ...
            VersionlessTypes.Add("dtmi:dtdl:class:Map");
            ...
            PropertyNames.Add("mapKey");
            PropertyNames.Add("mapValue");
            ...
            BadTypeActionFormat[2] = "Provide a @type{line3} of Map, or provide a value for property '{property}'{line1} with @type of Map.";
            BadTypeActionFormat[3] = "Provide a @type{line3} of Map, or provide a value for property '{property}'{line1} with @type of Map.";
            BadTypeActionFormat[4] = "Provide a @type{line3} of Map, or provide a value for property '{property}'{line1} with @type of Map.";

            BadTypeCauseFormat[2] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Map.";
            BadTypeCauseFormat[3] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Map.";
            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Map.";

            BadTypeLocatedCauseFormat[2] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Map.";
            BadTypeLocatedCauseFormat[3] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Map.";
            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Map.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DTMapInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the Map.</param>
        /// <param name="id">Identifier for the Map.</param>
        /// <param name="childOf">Identifier of the parent element in which this Map is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Map.</param>
        /// <param name="definedIn">Identifier of the partition in which this Map is defined.</param>
        internal DTMapInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.Map)
        {
            this.MapKey = null;
            this.MapValue = null;
        ...
        internal DTMapInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// </summary>
        /// <value>The 'mapKey' property of the DTDL element.</value>
        public DTMapKeyInfo MapKey { get; internal set; }

        /// <summary>
        /// Gets the value of the 'mapValue' property of the DTDL element that corresponds to this object.
        /// </summary>
        /// <value>The 'mapValue' property of the DTDL element.</value>
        public DTMapValueInfo MapValue { get; internal set; }

        /// <summary>
        /// Get the DTMI that identifies type Map in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type Map.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:Map;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTMapInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTMapInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTMapInfo</c> object to compare to the first.</param>
        ...
        /// <summary>
        /// Compares to another <c>DTMapInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTMapInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTMapInfo other)
        {
            return base.DeepEquals(other)
                && (this.MapKey?.DeepEquals(other.MapKey) ?? ReferenceEquals(null, other.MapKey))
                && (this.MapValue?.DeepEquals(other.MapValue) ?? ReferenceEquals(null, other.MapValue))
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTMapInfo)other);
        }
        ...
        public virtual bool Equals(DTMapInfo other)
        {
            return base.Equals(other)
                ...
                && this.MapKey?.Id == other.MapKey?.Id
                && this.MapValue?.Id == other.MapValue?.Id
                && this.supplementalTypeIds.SetEquals(other.supplementalTypeIds)
                ;
        }
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTMapInfo)other);
        }
        ...
        {
            return otherObj is DTMapInfo other && this.Equals(other);
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked
            {
                hashCode = (hashCode * 131) + (ReferenceEquals(null, this.MapKey) ? 0 : this.MapKey.Id.GetHashCode());
                hashCode = (hashCode * 131) + (ReferenceEquals(null, this.MapValue) ? 0 : this.MapValue.Id.GetHashCode());
        ...
        /// <summary>
        /// Validate a <c>JsonElement</c> to determine whether it is a JSON object that conforms to the specific Map element defined in the model.
        /// </summary>
        ...
        void IConstrainer.AddPropertyValueConstraint(string propertyName, ValueConstraint valueConstraint)
        {
            switch (propertyName)
            {
                ...
                case "displayName":
                    ...
                    break;
                case "mapKey":
                    if (this.mapKeyValueConstraints == null)
                    {
                        this.mapKeyValueConstraints = new List<ValueConstraint>();
                    }

                    this.mapKeyValueConstraints.Add(valueConstraint);
                    break;
                case "mapValue":
                    if (this.mapValueValueConstraints == null)
                    {
                        this.mapValueValueConstraints = new List<ValueConstraint>();
                    }

                    this.mapValueValueConstraints.Add(valueConstraint);
                    break;
            }
        }
        ...
        void IPropertyInstanceBinder.AddInstanceProperty(string propertyName, string instancePropertyName)
        {
            ...
            {
                case "mapKey":
                    if (this.mapKeyInstanceProperties == null)
                    {
                        this.mapKeyInstanceProperties = new List<string>();
                    }

                    this.mapKeyInstanceProperties.Add(instancePropertyName);
                    break;
                case "mapValue":
                    if (this.mapValueInstanceProperties == null)
                    {
                        this.mapValueInstanceProperties = new List<string>();
                    }

                    this.mapValueInstanceProperties.Add(instancePropertyName);
                    break;
            }
        }

        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTMapInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTMapInfo elementInfo = (DTMapInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTMapInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTMapInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTMapInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        internal override bool CheckDepthOfElementSchemaOrSchema(int depth, int depthLimit, bool allowSelf, List<Dtmi> tooDeepElementIds, out Dictionary<string, JsonLdElement> tooDeepElts, ParsingErrorCollection parsingErrorCollection)
        {
            if (this.MapKey != null)
            {
                if (!this.MapKey.CheckDepthOfElementSchemaOrSchema(depth, depthLimit, allowSelf, tooDeepElementIds, out tooDeepElts, parsingErrorCollection))
                {
            ...
            {
                if (!this.MapValue.CheckDepthOfElementSchemaOrSchema(depth, depthLimit, allowSelf, tooDeepElementIds, out tooDeepElts, parsingErrorCollection))
                {
                    if (tooDeepElementIds.Contains(this.Id))
                    {
                        if (!allowSelf)
        ...
        internal override bool TryGetDescendantSchemaArray(out Dtmi elementId, out Dictionary<string, JsonLdElement> excludedElts)
        {
            ...
            if (this.MapKey != null)
            {
                if (this.MapKey.TryGetDescendantSchemaArray(out elementId, out excludedElts))
                {
            ...
            if (this.MapValue != null)
            {
                if (this.MapValue.TryGetDescendantSchemaArray(out elementId, out excludedElts))
                {
                    this.idOfDescendantSchemaArray = elementId;
                    this.eltsOfDescendantSchemaArray = excludedElts;
                    return true;
        ...
        internal override bool TrySetObjectProperty(string propertyName, string layer, JsonLdProperty propProp, DTEntityInfo element, string keyProp, string keyValue, ParsingErrorCollection parsingErrorCollection)
        {
            ...
            switch (propertyName)
            {
                ...
                case "dtmi:dtdl:property:mapKey;4":
                    if (this.MapKey != null)
                    {
                        if (this.MapKey.Id != element.Id)
                        {
                            JsonLdProperty extantProp = this.JsonLdElements[this.mapKeyPropertyLayer].Properties.FirstOrDefault(p => p.Name == "mapKey");
                            parsingErrorCollection.Notify(
                                "inconsistentObjectValues",
                                elementId: this.Id,
                                propertyName: "mapKey",
                                propertyValue: element.Id.ToString(),
                                valueRestriction: this.MapKey.Id.ToString(),
                    ...
                    {
                        this.MapKey = (DTMapKeyInfo)element;
                        this.mapKeyPropertyLayer = layer;
                    }
                ...
                case "dtmi:dtdl:property:mapValue;4":
                    if (this.MapValue != null)
                    {
                        if (this.MapValue.Id != element.Id)
                        {
                            JsonLdProperty extantProp = this.JsonLdElements[this.mapValuePropertyLayer].Properties.FirstOrDefault(p => p.Name == "mapValue");
                            parsingErrorCollection.Notify(
                                "inconsistentObjectValues",
                                elementId: this.Id,
                                propertyName: "mapValue",
                                propertyValue: element.Id.ToString(),
                                valueRestriction: this.MapValue.Id.ToString(),
                                incidentProperty: propProp,
                                extantProperty: extantProp,
                                layer: layer);
                        }
                    ...
                    {
                        this.MapValue = (DTMapValueInfo)element;
                        this.mapValuePropertyLayer = layer;
                    }
        ...
        internal override int GetCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(bool allowSelf, ParsingErrorCollection parsingErrorCollection)
        {
            ...
            if (this.MapValue != null)
            {
                this.countOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrowValue += this.MapValue.GetCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(allowSelf, parsingErrorCollection) + 1;
            }
        ...
        internal override void CheckDescendantEnumValueDatatype(Dtmi ancestorId, Dictionary<string, JsonLdElement> ancestorElts, Type datatype, ParsingErrorCollection parsingErrorCollection)
        {
            if (this.checkedDescendantEnumValueDatatype != datatype)
            {
                ...
                if (this.MapKey != null)
                {
                    this.MapKey.CheckDescendantEnumValueDatatype(ancestorId, ancestorElts, datatype, parsingErrorCollection);
                }

                if (this.MapValue != null)
                {
                    this.MapValue.CheckDescendantEnumValueDatatype(ancestorId, ancestorElts, datatype, parsingErrorCollection);
                }
            }
        }
        ...
        internal override void ParsePropertiesV2(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, AggregateContext aggregateContext, HashSet<Dtmi> immediateSupplementalTypeIds, List<string> immediateUndefinedTypes, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi definedIn, bool globalize, bool allowReservedIds, bool tolerateSolecisms)
        {
            ...
            JsonLdProperty mapKeyProperty = null;
            JsonLdProperty mapValueProperty = null;
                    ...
                    case "dtmi:dtdl:property:mapKey;2":
                        if (mapKeyProperty != null)
                        {
                            parsingErrorCollection.Notify(
                                ...
                                propertyName: "mapKey",
                                incidentProperty: prop,
                                extantProperty: mapKeyProperty,
                                layer: layer);
                        }
                        else
                        {
                            mapKeyProperty = prop;
                            DTMapKeyInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.mapKeyValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "mapKey", null, null, 1, isPlural: false, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, tolerateSolecisms: tolerateSolecisms, allowedVersions: this.mapKeyAllowedVersionsV2);
                        }
                    ...
                    case "dtmi:dtdl:property:mapValue;2":
                        if (mapValueProperty != null)
                        {
                            parsingErrorCollection.Notify(
                                ...
                                propertyName: "mapValue",
                                incidentProperty: prop,
                                extantProperty: mapValueProperty,
                                layer: layer);
                        }
                        else
                        {
                            mapValueProperty = prop;
                            DTMapValueInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.mapValueValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "mapValue", null, null, 1, isPlural: false, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, tolerateSolecisms: tolerateSolecisms, allowedVersions: this.mapValueAllowedVersionsV2);
                        }
            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:mapKey;3":
                        ...
                        {
                            mapKeyProperty = prop;
                            DTMapKeyInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.mapKeyValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "mapKey", null, null, 1, isPlural: false, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, tolerateSolecisms: tolerateSolecisms, allowedVersions: this.mapKeyAllowedVersionsV3);
                        }
                    ...
                    case "dtmi:dtdl:property:mapValue;3":
                        ...
                        {
                            mapValueProperty = prop;
                            DTMapValueInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.mapValueValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "mapValue", null, null, 1, isPlural: false, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, tolerateSolecisms: tolerateSolecisms, allowedVersions: this.mapValueAllowedVersionsV3);
                        }
            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:mapKey;4":
                        ...
                        {
                            mapKeyProperty = prop;
                            DTMapKeyInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.mapKeyValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "mapKey", null, null, 1, isPlural: false, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, tolerateSolecisms: tolerateSolecisms, allowedVersions: this.mapKeyAllowedVersionsV4);
                        }
                    ...
                    case "dtmi:dtdl:property:mapValue;4":
                        ...
                        {
                            mapValueProperty = prop;
                            DTMapValueInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.mapValueValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "mapValue", null, null, 1, isPlural: false, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, tolerateSolecisms: tolerateSolecisms, allowedVersions: this.mapValueAllowedVersionsV4);
                        }
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:Map;{this.LanguageMajorVersion}");
            }

            jsonWriter.WriteString("mapKey", this.MapKey?.Id?.ToString());

            jsonWriter.WriteString("mapValue", this.MapValue?.Id?.ToString());
        }
        ...
        {
            if (instanceElt.ValueKind != JsonValueKind.Object)
            {
                violations.Add($">>{instanceElt.GetRawText()}<< is not a JSON object");
                return false;
            }

            foreach (JsonProperty child in instanceElt.EnumerateObject())
            {
                if (!this.MapValue.ValidateInstance(child.Value, child.Name, violations))
                {
                    continue;
                }
            }
        ...
        private void CheckRestrictionsV2(ParsingErrorCollection parsingErrorCollection)
        {
            if (this.mapKeyInstanceProperties != null)
            {
                foreach (string instanceProp in this.mapKeyInstanceProperties)
                {
                    object supplementalProperty = this.supplementalProperties[instanceProp];
                    IReadOnlyCollection<string> violations = supplementalProperty is JsonElement jsonElement ? this.MapKey.ValidateInstance(jsonElement) : this.MapKey.ValidateInstance(supplementalProperty.ToString());
                    if (violations.Any())
                    {
                        ...
                        JsonLdProperty conformanceProp = this.JsonLdElements.FirstOrDefault(e => e.Value.Properties.Any(p => p.Name == "mapKey")).Value?.Properties?.First(p => p.Name == "mapKey");

                        parsingErrorCollection.Notify(
                            "nonConformantPropertyValue",
                            elementId: this.Id,
                            propertyName: instanceTerm,
                            governingPropertyName: "mapKey",
            ...
            if (this.mapValueInstanceProperties != null)
            {
                foreach (string instanceProp in this.mapValueInstanceProperties)
                {
                    object supplementalProperty = this.supplementalProperties[instanceProp];
                    IReadOnlyCollection<string> violations = supplementalProperty is JsonElement jsonElement ? this.MapValue.ValidateInstance(jsonElement) : this.MapValue.ValidateInstance(supplementalProperty.ToString());
                    if (violations.Any())
                    {
                        string violationPostscript = violations.Count > 1 ? $", plus {violations.Count - 1} other violation(s)" : string.Empty;
                        string instanceTerm = ContextCollection.GetTermOrUri(new Uri(instanceProp));
                        JsonLdProperty instancePropProp = this.JsonLdElements.FirstOrDefault(e => e.Value.Properties.Any(p => p.Name == instanceProp || p.Name == instanceTerm)).Value?.Properties?.First(p => p.Name == instanceProp || p.Name == instanceTerm);
                        JsonLdProperty conformanceProp = this.JsonLdElements.FirstOrDefault(e => e.Value.Properties.Any(p => p.Name == "mapValue")).Value?.Properties?.First(p => p.Name == "mapValue");

                        parsingErrorCollection.Notify(
                            "nonConformantPropertyValue",
                            elementId: this.Id,
                            propertyName: instanceTerm,
                            governingPropertyName: "mapValue",
                            violations: violations,
                            violationCount: violations.Count,
                            incidentValues: instancePropProp.Values,
                            governingValues: conformanceProp.Values);
