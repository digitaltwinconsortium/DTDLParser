...
namespace DTDLParser.Models
{
    ...
    public class DTEnumInfo : DTComplexSchemaInfo, ITypeChecker, IConstrainer, IPropertyInstanceBinder, IEquatable<DTEnumInfo>
    {
        ...
        public override int GetHashCode()
        {
            ...
            unchecked
            {
                hashCode = (hashCode * 131) + (ReferenceEquals(null, this.ValueSchema) ? 0 : this.ValueSchema.GetHashCode());
        ...
        internal override bool CheckDepthOfElementSchemaOrSchema(int depth, int depthLimit, out Dtmi tooDeepElementId, out Dictionary<string, JsonLdElement> tooDeepElts, ParsingErrorCollection parsingErrorCollection)
        {
            ...
            {
                if (!this.ValueSchema.CheckDepthOfElementSchemaOrSchema(depth, depthLimit, out tooDeepElementId, out tooDeepElts, parsingErrorCollection))
                {
                    if (tooDeepElementId == this.Id)
                    {
                        parsingErrorCollection.Notify(
                ...
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:enumValues;2":
                        ...
                        else
                        {
                            ...
                            DTEnumValueInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.enumValuesValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "enumValues", "name", null, 1, isPlural: true, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, allowIdReferenceSyntax: allowIdReferenceSyntax, ignoreElementsWithAutoIDsAndDuplicateNames: ignoreElementsWithAutoIDsAndDuplicateNames, allowedVersions: this.enumValuesAllowedVersionsV2);
                        }
                    ...
                    case "dtmi:dtdl:property:valueSchema;2":
                        ...
                        else
                        {
                            ...
                            DTPrimitiveSchemaInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.valueSchemaValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "valueSchema", null, null, 1, isPlural: false, idRequired: true, typeRequired: true, globalize: globalize, allowReservedIds: allowReservedIds, allowIdReferenceSyntax: allowIdReferenceSyntax, ignoreElementsWithAutoIDsAndDuplicateNames: ignoreElementsWithAutoIDsAndDuplicateNames, allowedVersions: this.valueSchemaAllowedVersionsV2);
                        }
            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:enumValues;3":
                        ...
                        {
                            enumValuesProperty = prop;
                            DTEnumValueInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.enumValuesValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "enumValues", "name", null, 0, isPlural: true, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, allowIdReferenceSyntax: allowIdReferenceSyntax, ignoreElementsWithAutoIDsAndDuplicateNames: ignoreElementsWithAutoIDsAndDuplicateNames, allowedVersions: this.enumValuesAllowedVersionsV3);
                        }
                    ...
                    case "dtmi:dtdl:property:valueSchema;3":
                        ...
                        {
                            valueSchemaProperty = prop;
                            DTPrimitiveSchemaInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.valueSchemaValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "valueSchema", null, null, 1, isPlural: false, idRequired: true, typeRequired: true, globalize: globalize, allowReservedIds: allowReservedIds, allowIdReferenceSyntax: allowIdReferenceSyntax, ignoreElementsWithAutoIDsAndDuplicateNames: ignoreElementsWithAutoIDsAndDuplicateNames, allowedVersions: this.valueSchemaAllowedVersionsV3);
                        }
