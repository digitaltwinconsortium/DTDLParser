...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTFloatInfo : DTNumericSchemaInfo, ITypeChecker, IConstrainer, IEquatable<DTFloatInfo>
    {
        ...
        static DTFloatInfo()
        {
            ...
            VersionlessTypes.Add("dtmi:dtdl:class:Float");
            ...
            BadTypeActionFormat[2] = "Use this standard value for property '{property}'{line1}: float.";
            BadTypeActionFormat[3] = "Use this standard value for property '{property}'{line1}: float.";
            BadTypeActionFormat[4] = "Use this standard value for property '{property}'{line1}: float.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DTFloatInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the Float.</param>
        /// <param name="id">Identifier for the Float.</param>
        /// <param name="childOf">Identifier of the parent element in which this Float is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Float.</param>
        /// <param name="definedIn">Identifier of the partition in which this Float is defined.</param>
        internal DTFloatInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.Float)
        {
        ...
        internal DTFloatInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type Float in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type Float.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:Float;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTFloatInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTFloatInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTFloatInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTFloatInfo x, DTFloatInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTFloatInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTFloatInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTFloatInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTFloatInfo)other);
        }
        ...
        /// <param name="other">The other <c>DTFloatInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTFloatInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTFloatInfo)other);
        }
        ...
        {
            return otherObj is DTFloatInfo other && this.Equals(other);
        }
        ...
        /// <summary>
        /// Validate a <c>JsonElement</c> to determine whether it is a numeric value that conforms to the XSD definition of 'float'.
        /// </summary>
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTFloatInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTFloatInfo elementInfo = (DTFloatInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTFloatInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTFloatInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTFloatInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:Float;{this.LanguageMajorVersion}");
            }
        }
        ...
        private bool ValidateInstanceV2(JsonElement instanceElt, string instanceName, List<string> violations)
        {
            ...
            if (!float.TryParse(instanceElt.GetRawText(), out float val) || float.IsInfinity(val))
            {
                violations.Add($"{instanceElt.GetRawText()} does not conform to the XSD definition of 'float'");
                return false;
            }
