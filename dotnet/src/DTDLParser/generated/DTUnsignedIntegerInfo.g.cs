...
namespace DTDLParser.Models
{
    ...
    /// <summary>
    /// Class <c>DTUnsignedIntegerInfo</c> corresponds to an element of type UnsignedInteger in a DTDL model.
    /// </summary>
    public class DTUnsignedIntegerInfo : DTNumericSchemaInfo, ITypeChecker, IConstrainer, IEquatable<DTUnsignedIntegerInfo>
    {
        ...
        private static readonly Regex ElementValueInstanceRegexPatternV4 = new Regex(@"^[0-9]+$", RegexOptions.Compiled);
        ...
        static DTUnsignedIntegerInfo()
        {
            ...
            BadTypeActionFormat[4] = "Use this standard value for property '{property}'{line1}: unsignedInteger.";

            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that is not a standard value for this property.";

            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that is not a standard value for this property.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DTUnsignedIntegerInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the UnsignedInteger.</param>
        /// <param name="id">Identifier for the UnsignedInteger.</param>
        /// <param name="childOf">Identifier of the parent element in which this UnsignedInteger is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this UnsignedInteger.</param>
        /// <param name="definedIn">Identifier of the partition in which this UnsignedInteger is defined.</param>
        internal DTUnsignedIntegerInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.UnsignedInteger)
        {
        ...
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this UnsignedInteger.</param>
        /// <param name="definedIn">Identifier of the partition in which this UnsignedInteger is defined.</param>
        /// <param name="entityKind">The kind of Entity, which may be other than UnsignedInteger if this constructor is called from a derived class.</param>
        internal DTUnsignedIntegerInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type UnsignedInteger in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type UnsignedInteger.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:UnsignedInteger;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTUnsignedIntegerInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTUnsignedIntegerInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTUnsignedIntegerInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTUnsignedIntegerInfo x, DTUnsignedIntegerInfo y)
        {
        ...
        /// <summary>
        /// Determines whether two <c>DTUnsignedIntegerInfo</c> objects are equal.
        /// </summary>
        /// <param name="x">One <c>DTUnsignedIntegerInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTUnsignedIntegerInfo</c> object to compare to the first.</param>
        ...
        /// <summary>
        /// Compares to another <c>DTUnsignedIntegerInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTUnsignedIntegerInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTUnsignedIntegerInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTUnsignedIntegerInfo)other);
        }
        ...
        /// <summary>
        /// Compares to another <c>DTUnsignedIntegerInfo</c> object.
        /// </summary>
        /// <param name="other">The other <c>DTUnsignedIntegerInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTUnsignedIntegerInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTUnsignedIntegerInfo)other);
        }
        ...
        {
            return otherObj is DTUnsignedIntegerInfo other && this.Equals(other);
        }
        ...
        /// <summary>
        /// Validate a <c>JsonElement</c> to determine whether it is a numeric value that conforms to the XSD definition of 'unsignedInt'.
        /// </summary>
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTUnsignedIntegerInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTUnsignedIntegerInfo elementInfo = (DTUnsignedIntegerInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTUnsignedIntegerInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTUnsignedIntegerInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTUnsignedIntegerInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        /// <summary>
        /// Parse the properties in a JSON UnsignedInteger object.
        /// </summary>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:UnsignedInteger;{this.LanguageMajorVersion}");
            }
        }
        ...
        private bool ValidateInstanceV4(JsonElement instanceElt, string instanceName, List<string> violations)
        {
            ...
            if (!uint.TryParse(instanceElt.GetRawText(), out uint _))
            {
                violations.Add($"{instanceElt.GetRawText()} does not conform to the XSD definition of 'unsignedInt'");
                return false;
            }

            if (!ElementValueInstanceRegexPatternV4.IsMatch(instanceElt.GetRawText()))
            {
                violations.Add($"\"{instanceElt.GetRawText()}\" does not conform to the XSD definition of 'unsignedInt'");
                return false;
            }
