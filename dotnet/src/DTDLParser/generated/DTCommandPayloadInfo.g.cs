...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTCommandPayloadInfo : DTSchemaFieldInfo, ITypeChecker, IConstrainer, IPropertyInstanceBinder, IEquatable<DTCommandPayloadInfo>
    {
        ...
        static DTCommandPayloadInfo()
        {
            ...
            BadTypeActionFormat[2] = "Provide a @type{line3} of CommandPayload, or provide a value for property '{property}'{line1} with @type of CommandPayload.";
            BadTypeActionFormat[3] = "Provide a @type{line3} of CommandRequest or CommandResponse, or provide a value for property '{property}'{line1} with @type of CommandRequest or CommandResponse.";
            BadTypeActionFormat[4] = "Provide a @type{line3} of CommandRequest or CommandResponse, or provide a value for property '{property}'{line1} with @type of CommandRequest or CommandResponse.";

            BadTypeCauseFormat[2] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of CommandPayload.";
            BadTypeCauseFormat[3] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of CommandRequest or CommandResponse.";
            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of CommandRequest or CommandResponse.";

            BadTypeLocatedCauseFormat[2] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of CommandPayload.";
            BadTypeLocatedCauseFormat[3] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of CommandRequest or CommandResponse.";
            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of CommandRequest or CommandResponse.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DTCommandPayloadInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the CommandPayload.</param>
        /// <param name="id">Identifier for the CommandPayload.</param>
        /// <param name="childOf">Identifier of the parent element in which this CommandPayload is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this CommandPayload.</param>
        ...
        /// </summary>
        /// <value>The DTMI for the DTDL type CommandPayload.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:CommandPayload;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTCommandPayloadInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTCommandPayloadInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTCommandPayloadInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTCommandPayloadInfo x, DTCommandPayloadInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTCommandPayloadInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTCommandPayloadInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTCommandPayloadInfo other)
        {
        ...
        /// <param name="other">The other <c>DTCommandPayloadInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTCommandPayloadInfo other)
        {
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTCommandPayloadInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTCommandPayloadInfo elementInfo = (DTCommandPayloadInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTCommandPayloadInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTCommandPayloadInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTCommandPayloadInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
