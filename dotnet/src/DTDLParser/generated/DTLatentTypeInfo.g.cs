...
namespace DTDLParser.Models
{
    ...
    /// <summary>
    /// Class <c>DTLatentTypeInfo</c> corresponds to an element of type LatentType in a DTDL model.
    /// </summary>
    public class DTLatentTypeInfo : DTEntityInfo, ITypeChecker, IConstrainer, IEquatable<DTLatentTypeInfo>
    {
        ...
        static DTLatentTypeInfo()
        {
            VersionlessTypes.Add("dtmi:dtdl:class:Entity");
            VersionlessTypes.Add("dtmi:dtdl:class:LatentType");
            ...
            BadTypeActionFormat[3] = "Provide a @type{line3} of a subtype of LatentType, or provide a value for property '{property}'{line1} with @type of a subtype of LatentType.";
            BadTypeActionFormat[4] = "Provide a @type{line3} of a subtype of LatentType, or provide a value for property '{property}'{line1} with @type of a subtype of LatentType.";

            BadTypeCauseFormat[3] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that is not a subtype of LatentType.";
            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that is not a subtype of LatentType.";

            BadTypeLocatedCauseFormat[3] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that is not a subtype of LatentType.";
            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that is not a subtype of LatentType.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DTLatentTypeInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the LatentType.</param>
        /// <param name="id">Identifier for the LatentType.</param>
        /// <param name="childOf">Identifier of the parent element in which this LatentType is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this LatentType.</param>
        /// <param name="definedIn">Identifier of the partition in which this LatentType is defined.</param>
        /// <param name="implicitSupplementalTypeId">Identifier for an implicit supplemantal type.</param>
        internal DTLatentTypeInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, Dtmi implicitSupplementalTypeId)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.LatentType)
        {
        ...
        /// <param name="definedIn">Identifier of the partition in which this LatentType is defined.</param>
        /// <param name="implicitSupplementalTypeId">Identifier for an implicit supplemantal type.</param>
        /// <param name="entityKind">The kind of Entity, which may be other than LatentType if this constructor is called from a derived class.</param>
        internal DTLatentTypeInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, Dtmi implicitSupplementalTypeId, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type LatentType in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type LatentType.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:LatentType;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTLatentTypeInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTLatentTypeInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTLatentTypeInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTLatentTypeInfo x, DTLatentTypeInfo y)
        {
        ...
        /// <summary>
        /// Determines whether two <c>DTLatentTypeInfo</c> objects are equal.
        /// </summary>
        /// <param name="x">One <c>DTLatentTypeInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTLatentTypeInfo</c> object to compare to the first.</param>
        ...
        /// <summary>
        /// Compares to another <c>DTLatentTypeInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTLatentTypeInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTLatentTypeInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTLatentTypeInfo)other);
        }

        /// <summary>
        /// Compares to another <c>DTLatentTypeInfo</c> object.
        /// </summary>
        /// <param name="other">The other <c>DTLatentTypeInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTLatentTypeInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTLatentTypeInfo)other);
        }
        ...
        {
            return otherObj is DTLatentTypeInfo other && this.Equals(other);
        }
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTLatentTypeInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTLatentTypeInfo elementInfo = (DTLatentTypeInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTLatentTypeInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTLatentTypeInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTLatentTypeInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        /// <summary>
        /// Parse the properties in a JSON LatentType object.
        /// </summary>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:LatentType;{this.LanguageMajorVersion}");
            }
        }
