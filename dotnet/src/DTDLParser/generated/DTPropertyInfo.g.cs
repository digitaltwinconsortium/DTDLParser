...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTPropertyInfo : DTContentInfo, ITypeChecker, IConstrainer, IPropertyInstanceBinder, IEquatable<DTPropertyInfo>
    {
        ...
        static DTPropertyInfo()
        {
            ...
            VersionlessTypes.Add("dtmi:dtdl:class:Property");
            ...
            BadTypeActionFormat[2] = "Provide a @type{line3} of Property, or provide a value for property '{property}'{line1} with @type of Property.";
            BadTypeActionFormat[3] = "Provide a @type{line3} of Property, or provide a value for property '{property}'{line1} with @type of Property.";
            BadTypeActionFormat[4] = "Provide a @type{line3} of Property, or provide a value for property '{property}'{line1} with @type of Property.";

            BadTypeCauseFormat[2] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Property.";
            BadTypeCauseFormat[3] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Property.";
            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Property.";

            BadTypeLocatedCauseFormat[2] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Property.";
            BadTypeLocatedCauseFormat[3] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Property.";
            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Property.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DTPropertyInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the Property.</param>
        /// <param name="id">Identifier for the Property.</param>
        /// <param name="childOf">Identifier of the parent element in which this Property is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Property.</param>
        /// <param name="definedIn">Identifier of the partition in which this Property is defined.</param>
        internal DTPropertyInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.Property)
        {
            this.Schema = null;
            this.Writable = false;
        ...
        internal DTPropertyInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type Property in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type Property.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:Property;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTPropertyInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTPropertyInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTPropertyInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTPropertyInfo x, DTPropertyInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTPropertyInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTPropertyInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTPropertyInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTPropertyInfo)other);
        }
        ...
        /// <param name="other">The other <c>DTPropertyInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTPropertyInfo other)
        {
        ...
        {
            return otherObj is DTPropertyInfo other && this.Equals(other);
        }

        /// <inheritdoc/>
        public override bool Equals(DTNamedEntityInfo other)
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTPropertyInfo)other);
        }
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTPropertyInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTPropertyInfo elementInfo = (DTPropertyInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTPropertyInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTPropertyInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTPropertyInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:schema;2":
                        ...
                        {
                            schemaProperty = prop;
                            DTSchemaInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.schemaValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "schema", null, null, 1, isPlural: false, idRequired: false, typeRequired: true, globalize: globalize, allowReservedIds: allowReservedIds, tolerateSolecisms: tolerateSolecisms, allowedVersions: this.schemaAllowedVersionsV2);
                        }
            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:schema;3":
                        ...
                        {
                            schemaProperty = prop;
                            DTSchemaInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.schemaValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "schema", null, null, 1, isPlural: false, idRequired: false, typeRequired: true, globalize: globalize, allowReservedIds: allowReservedIds, tolerateSolecisms: tolerateSolecisms, allowedVersions: this.schemaAllowedVersionsV3);
                        }
            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:schema;4":
                        ...
                        {
                            schemaProperty = prop;
                            DTSchemaInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.schemaValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "schema", null, null, 1, isPlural: false, idRequired: false, typeRequired: true, globalize: globalize, allowReservedIds: allowReservedIds, tolerateSolecisms: tolerateSolecisms, allowedVersions: this.schemaAllowedVersionsV4);
                        }
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:Property;{this.LanguageMajorVersion}");
            }
        ...
        private void CheckRestrictionsV2(ParsingErrorCollection parsingErrorCollection)
        {
            ...
            if (this.TryGetDescendantSchemaArray(out Dtmi excludedArrayElementId, out Dictionary<string, JsonLdElement> excludedArrayElts))
            {
                JsonLdElement ancestorElt = this.JsonLdElements.FirstOrDefault(e => e.Value.Properties.Any(p => p.Name == "schema")).Value;
                JsonLdElement descendantElt = excludedArrayElts.FirstOrDefault(e => e.Value.Types.Contains("Array")).Value;

                parsingErrorCollection.Notify(
                    "excludedType",
                    elementId: this.Id,
                    propertyDisjunction: "'schema'",
                    referenceId: excludedArrayElementId,
                    referenceType: "Array",
                    elementType: "Property",
                    ancestorElement: ancestorElt,
                    descendantElement: descendantElt);
            }
        }
