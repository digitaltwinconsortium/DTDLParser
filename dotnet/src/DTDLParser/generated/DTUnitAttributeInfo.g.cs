...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTUnitAttributeInfo : DTNamedEntityInfo, ITypeChecker, IConstrainer, IEquatable<DTUnitAttributeInfo>
    {
        ...
        static DTUnitAttributeInfo()
        {
            ...
            BadTypeActionFormat[2] = "Provide a @type{line3} of a subtype of UnitAttribute, or provide a value for property '{property}'{line1} with @type of a subtype of UnitAttribute.";
            BadTypeActionFormat[3] = "Provide a @type{line3} of a subtype of UnitAttribute, or provide a value for property '{property}'{line1} with @type of a subtype of UnitAttribute.";
            BadTypeActionFormat[4] = "Provide a @type{line3} of a subtype of UnitAttribute, or provide a value for property '{property}'{line1} with @type of a subtype of UnitAttribute.";

            BadTypeCauseFormat[2] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that is not a subtype of UnitAttribute.";
            BadTypeCauseFormat[3] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that is not a subtype of UnitAttribute.";
            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that is not a subtype of UnitAttribute.";

            BadTypeLocatedCauseFormat[2] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that is not a subtype of UnitAttribute.";
            BadTypeLocatedCauseFormat[3] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that is not a subtype of UnitAttribute.";
            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that is not a subtype of UnitAttribute.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DTUnitAttributeInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the UnitAttribute.</param>
        /// <param name="id">Identifier for the UnitAttribute.</param>
        /// <param name="childOf">Identifier of the parent element in which this UnitAttribute is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this UnitAttribute.</param>
        ...
        internal DTUnitAttributeInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, Dtmi implicitSupplementalTypeId)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.UnitAttribute)
        {
        ...
        internal DTUnitAttributeInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, Dtmi implicitSupplementalTypeId, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type UnitAttribute in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type UnitAttribute.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:UnitAttribute;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTUnitAttributeInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTUnitAttributeInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTUnitAttributeInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTUnitAttributeInfo x, DTUnitAttributeInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTUnitAttributeInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTUnitAttributeInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTUnitAttributeInfo other)
        {
        ...
        /// <param name="other">The other <c>DTUnitAttributeInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTUnitAttributeInfo other)
        {
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTUnitAttributeInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTUnitAttributeInfo elementInfo = (DTUnitAttributeInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTUnitAttributeInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTUnitAttributeInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTUnitAttributeInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:UnitAttribute;{this.LanguageMajorVersion}");
            }
        }
