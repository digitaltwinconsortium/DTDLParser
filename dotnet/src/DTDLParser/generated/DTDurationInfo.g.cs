...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTDurationInfo : DTTemporalSchemaInfo, ITypeChecker, IConstrainer, IEquatable<DTDurationInfo>
    {
        ...
        private static readonly Regex ElementValueInstanceRegexPatternV2 = new Regex(@"^P(?!$)(?:(?:(?:(?:\d+Y)|(?:\d+\.\d+Y$))?(?:(?:\d+M)|(?:\d+\.\d+M$))?)|(?:(?:(?:\d+W)|(?:\d+\.\d+W$))?))(?:(?:\d+D)|(?:\d+\.\d+D$))?(?:T(?!$)(?:(?:\d+H)|(?:\d+\.\d+H$))?(?:(?:\d+M)|(?:\d+\.\d+M$))?(?:\d+(?:\.\d+)?S)?)?$", RegexOptions.Compiled);

        private static readonly Regex ElementValueInstanceRegexPatternV3 = new Regex(@"^P(?!$)(?:(?:(?:(?:\d+Y)|(?:\d+\.\d+Y$))?(?:(?:\d+M)|(?:\d+\.\d+M$))?)|(?:(?:(?:\d+W)|(?:\d+\.\d+W$))?))(?:(?:\d+D)|(?:\d+\.\d+D$))?(?:T(?!$)(?:(?:\d+H)|(?:\d+\.\d+H$))?(?:(?:\d+M)|(?:\d+\.\d+M$))?(?:\d+(?:\.\d+)?S)?)?$", RegexOptions.Compiled);

        private static readonly Regex ElementValueInstanceRegexPatternV4 = new Regex(@"^P(?!$)(?:(?:(?:(?:\d+Y)|(?:\d+\.\d+Y$))?(?:(?:\d+M)|(?:\d+\.\d+M$))?)|(?:(?:(?:\d+W)|(?:\d+\.\d+W$))?))(?:(?:\d+D)|(?:\d+\.\d+D$))?(?:T(?!$)(?:(?:\d+H)|(?:\d+\.\d+H$))?(?:(?:\d+M)|(?:\d+\.\d+M$))?(?:\d+(?:\.\d+)?S)?)?$", RegexOptions.Compiled);
        ...
        static DTDurationInfo()
        {
            VersionlessTypes.Add("dtmi:dtdl:class:Duration");
            ...
            BadTypeActionFormat[2] = "Use this standard value for property '{property}'{line1}: duration.";
            BadTypeActionFormat[3] = "Use this standard value for property '{property}'{line1}: duration.";
            BadTypeActionFormat[4] = "Use this standard value for property '{property}'{line1}: duration.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DTDurationInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the Duration.</param>
        /// <param name="id">Identifier for the Duration.</param>
        /// <param name="childOf">Identifier of the parent element in which this Duration is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Duration.</param>
        /// <param name="definedIn">Identifier of the partition in which this Duration is defined.</param>
        internal DTDurationInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.Duration)
        {
        ...
        internal DTDurationInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type Duration in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type Duration.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:Duration;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTDurationInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTDurationInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTDurationInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTDurationInfo x, DTDurationInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTDurationInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTDurationInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTDurationInfo other)
        {
        ...
        /// <param name="other">The other <c>DTDurationInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTDurationInfo other)
        {
        ...
        {
            return otherObj is DTDurationInfo other && this.Equals(other);
        }
        ...
        /// <summary>
        /// Validate a <c>JsonElement</c> to determine whether it is a string value that conforms to the ISO 8601 definition of 'duration'.
        /// </summary>
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTDurationInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTDurationInfo elementInfo = (DTDurationInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTDurationInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTDurationInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTDurationInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        private bool ValidateInstanceV2(JsonElement instanceElt, string instanceName, List<string> violations)
        {
            ...
            {
                violations.Add($"\"{instanceElt.GetString()}\" does not conform to the ISO 8601 definition of 'duration'");
                return false;
            }
