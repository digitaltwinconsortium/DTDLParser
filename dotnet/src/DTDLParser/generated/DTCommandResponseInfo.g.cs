...
namespace DTDLParser.Models
{
    ...
    /// <summary>
    /// Class <c>DTCommandResponseInfo</c> corresponds to an element of type CommandResponse in a DTDL model.
    /// </summary>
    public class DTCommandResponseInfo : DTCommandPayloadInfo, ITypeChecker, IConstrainer, IPropertyInstanceBinder, IEquatable<DTCommandResponseInfo>
    {
        ...
        static DTCommandResponseInfo()
        {
            VersionlessTypes.Add("dtmi:dtdl:class:CommandPayload");
            VersionlessTypes.Add("dtmi:dtdl:class:CommandResponse");
            ...
            BadTypeActionFormat[3] = "Provide a @type{line3} of CommandResponse, or provide a value for property '{property}'{line1} with @type of CommandResponse.";
            BadTypeActionFormat[4] = "Provide a @type{line3} of CommandResponse, or provide a value for property '{property}'{line1} with @type of CommandResponse.";

            BadTypeCauseFormat[3] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of CommandResponse.";
            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of CommandResponse.";

            BadTypeLocatedCauseFormat[3] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of CommandResponse.";
            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of CommandResponse.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DTCommandResponseInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the CommandResponse.</param>
        /// <param name="id">Identifier for the CommandResponse.</param>
        /// <param name="childOf">Identifier of the parent element in which this CommandResponse is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this CommandResponse.</param>
        /// <param name="definedIn">Identifier of the partition in which this CommandResponse is defined.</param>
        internal DTCommandResponseInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.CommandResponse)
        {
        ...
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this CommandResponse.</param>
        /// <param name="definedIn">Identifier of the partition in which this CommandResponse is defined.</param>
        /// <param name="entityKind">The kind of Entity, which may be other than CommandResponse if this constructor is called from a derived class.</param>
        internal DTCommandResponseInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// </summary>
        /// <value>The DTMI for the DTDL type CommandResponse.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:CommandResponse;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTCommandResponseInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTCommandResponseInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTCommandResponseInfo</c> object to compare to the first.</param>
        ...
        /// <summary>
        /// Determines whether two <c>DTCommandResponseInfo</c> objects are equal.
        /// </summary>
        /// <param name="x">One <c>DTCommandResponseInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTCommandResponseInfo</c> object to compare to the first.</param>
        ...
        /// <summary>
        /// Compares to another <c>DTCommandResponseInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTCommandResponseInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTCommandResponseInfo)other);
        }
        ...
        /// <summary>
        /// Compares to another <c>DTCommandResponseInfo</c> object.
        /// </summary>
        /// <param name="other">The other <c>DTCommandResponseInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTCommandResponseInfo)other);
        }
        ...
        {
            return otherObj is DTCommandResponseInfo other && this.Equals(other);
        }
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTCommandResponseInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTCommandResponseInfo elementInfo = (DTCommandResponseInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTCommandResponseInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTCommandResponseInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTCommandResponseInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        /// <summary>
        /// Parse the properties in a JSON CommandResponse object.
        /// </summary>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:CommandResponse;{this.LanguageMajorVersion}");
            }
        }
