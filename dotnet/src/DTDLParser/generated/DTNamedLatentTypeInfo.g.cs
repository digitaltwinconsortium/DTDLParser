...
namespace DTDLParser.Models
{
    ...
    /// <summary>
    /// Class <c>DTNamedLatentTypeInfo</c> corresponds to an element of type NamedLatentType in a DTDL model.
    /// </summary>
    public class DTNamedLatentTypeInfo : DTNamedEntityInfo, ITypeChecker, IConstrainer, IEquatable<DTNamedLatentTypeInfo>
    {
        ...
        static DTNamedLatentTypeInfo()
        {
            ...
            BadTypeActionFormat[3] = "Provide a @type{line3} of a subtype of NamedLatentType, or provide a value for property '{property}'{line1} with @type of a subtype of NamedLatentType.";
            BadTypeActionFormat[4] = "Provide a @type{line3} of a subtype of NamedLatentType, or provide a value for property '{property}'{line1} with @type of a subtype of NamedLatentType.";

            BadTypeCauseFormat[3] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that is not a subtype of NamedLatentType.";
            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that is not a subtype of NamedLatentType.";

            BadTypeLocatedCauseFormat[3] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that is not a subtype of NamedLatentType.";
            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that is not a subtype of NamedLatentType.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DTNamedLatentTypeInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the NamedLatentType.</param>
        /// <param name="id">Identifier for the NamedLatentType.</param>
        /// <param name="childOf">Identifier of the parent element in which this NamedLatentType is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this NamedLatentType.</param>
        /// <param name="definedIn">Identifier of the partition in which this NamedLatentType is defined.</param>
        /// <param name="implicitSupplementalTypeId">Identifier for an implicit supplemantal type.</param>
        internal DTNamedLatentTypeInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, Dtmi implicitSupplementalTypeId)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.NamedLatentType)
        {
        ...
        /// <param name="definedIn">Identifier of the partition in which this NamedLatentType is defined.</param>
        /// <param name="implicitSupplementalTypeId">Identifier for an implicit supplemantal type.</param>
        /// <param name="entityKind">The kind of Entity, which may be other than NamedLatentType if this constructor is called from a derived class.</param>
        internal DTNamedLatentTypeInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, Dtmi implicitSupplementalTypeId, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type NamedLatentType in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type NamedLatentType.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:NamedLatentType;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTNamedLatentTypeInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTNamedLatentTypeInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTNamedLatentTypeInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTNamedLatentTypeInfo x, DTNamedLatentTypeInfo y)
        {
        ...
        /// <summary>
        /// Determines whether two <c>DTNamedLatentTypeInfo</c> objects are equal.
        /// </summary>
        /// <param name="x">One <c>DTNamedLatentTypeInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTNamedLatentTypeInfo</c> object to compare to the first.</param>
        ...
        /// <summary>
        /// Compares to another <c>DTNamedLatentTypeInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTNamedLatentTypeInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTNamedLatentTypeInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTNamedLatentTypeInfo)other);
        }
        ...
        {
            return otherObj is DTNamedLatentTypeInfo other && this.Equals(other);
        }

        /// <summary>
        /// Compares to another <c>DTNamedLatentTypeInfo</c> object.
        /// </summary>
        /// <param name="other">The other <c>DTNamedLatentTypeInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTNamedLatentTypeInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTNamedLatentTypeInfo)other);
        }
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTNamedLatentTypeInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTNamedLatentTypeInfo elementInfo = (DTNamedLatentTypeInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTNamedLatentTypeInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTNamedLatentTypeInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTNamedLatentTypeInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        /// <summary>
        /// Parse the properties in a JSON NamedLatentType object.
        /// </summary>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:NamedLatentType;{this.LanguageMajorVersion}");
            }
        }
