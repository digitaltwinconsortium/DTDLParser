...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTFieldInfo : DTSchemaFieldInfo, ITypeChecker, IConstrainer, IPropertyInstanceBinder, IEquatable<DTFieldInfo>
    {
        ...
        static DTFieldInfo()
        {
            ...
            VersionlessTypes.Add("dtmi:dtdl:class:Field");
            ...
            BadTypeActionFormat[2] = "Provide a @type{line3} of Field, or provide a value for property '{property}'{line1} with @type of Field.";
            BadTypeActionFormat[3] = "Provide a @type{line3} of Field, or provide a value for property '{property}'{line1} with @type of Field.";
            BadTypeActionFormat[4] = "Provide a @type{line3} of Field, or provide a value for property '{property}'{line1} with @type of Field.";

            BadTypeCauseFormat[2] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Field.";
            BadTypeCauseFormat[3] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Field.";
            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Field.";

            BadTypeLocatedCauseFormat[2] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Field.";
            BadTypeLocatedCauseFormat[3] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Field.";
            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Field.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DTFieldInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the Field.</param>
        /// <param name="id">Identifier for the Field.</param>
        /// <param name="childOf">Identifier of the parent element in which this Field is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Field.</param>
        /// <param name="definedIn">Identifier of the partition in which this Field is defined.</param>
        internal DTFieldInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.Field)
        {
        ...
        internal DTFieldInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type Field in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type Field.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:Field;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTFieldInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTFieldInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTFieldInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTFieldInfo x, DTFieldInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTFieldInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTFieldInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTFieldInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTFieldInfo)other);
        }
        ...
        /// <param name="other">The other <c>DTFieldInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTFieldInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTFieldInfo)other);
        }
        ...
        {
            return otherObj is DTFieldInfo other && this.Equals(other);
        }
        ...
        /// <summary>
        /// Validate a <c>JsonElement</c> to determine whether it conforms to the specific Field element defined in the model.
        /// </summary>
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTFieldInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTFieldInfo elementInfo = (DTFieldInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTFieldInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTFieldInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTFieldInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:Field;{this.LanguageMajorVersion}");
            }
        }
        ...
        private bool ValidateInstanceV2(JsonElement instanceElt, string instanceName, List<string> violations)
        {
            ...
            if (instanceName != this.Name)
            {
                violations.Add($">>{instanceName}<< does not have value {this.Name}");
                return false;
            }
