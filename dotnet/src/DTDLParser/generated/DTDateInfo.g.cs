...
namespace DTDLParser.Models
{
    ...
    public class DTDateInfo : DTTemporalSchemaInfo, ITypeChecker, IConstrainer, IEquatable<DTDateInfo>
    {
        ...
        private static readonly Regex ElementValueInstanceRegexPatternV4 = new Regex(@"^[0-9]{4}-[0-9]{2}-[0-9]{2}$", RegexOptions.Compiled);
        ...
        static DTDateInfo()
        {
            ...
            BadTypeActionFormat[4] = "Use this standard value for property '{property}'{line1}: date.";
