...
namespace DTDLParser
{
    ...
    internal partial class SupplementalTypeCollection
    {
        static SupplementalTypeCollection()
        {
            ...
            Dtmi articleTypeIdEV4 = new Dtmi("dtmi:iotoperations:class:Article;4");
            ...
            DTSupplementalTypeInfo articleInfoEV4 = new DTSupplementalTypeInfo(DTExtensionKind.AdjunctType, iotoperationsContextIdV4, articleTypeIdEV4, isAbstract: false, isMergeable: false, adjunctTypeTypeIdEV4);
            articleInfoEV4.AddProperty("dtmi:iotoperations:property:ontology;4", new Uri("http://www.w3.org/2001/XMLSchema#string"), 1, 1, null, null, 128, regex: null, hasUniqueValue: false, isPlural: false, isOptional: false, defaultLanguage: null, dtmiSeg: null, dictionaryKey: null, idRequired: false, typeRequired: true, childOf: null, instanceProperty: null, requiredValues: null, requiredValuesString: null, requiredLiteral: null);
            articleInfoEV4.AllowedCotypeKinds = new HashSet<DTEntityKind>() { DTEntityKind.Interface };
            articleInfoEV4.AllowedCotypeVersions = new HashSet<int>() { 4 };
            articleInfoEV4.DisallowedCocotypes = new HashSet<Dtmi>() { new Dtmi("dtmi:iotoperations:class:Event;4") };
            ...
            EndogenousSupplementalTypes[articleTypeIdEV4] = articleInfoEV4;
