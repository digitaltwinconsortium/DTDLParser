...
namespace DTDLParser.Models
{
    ...
    /// <summary>
    /// Class <c>DTUnsignedLongInfo</c> corresponds to an element of type UnsignedLong in a DTDL model.
    /// </summary>
    public class DTUnsignedLongInfo : DTNumericSchemaInfo, ITypeChecker, IConstrainer, IEquatable<DTUnsignedLongInfo>
    {
        ...
        static DTUnsignedLongInfo()
        {
            ...
            VersionlessTypes.Add("dtmi:dtdl:class:UnsignedLong");
            ...
            BadTypeActionFormat[4] = "Use this standard value for property '{property}'{line1}: unsignedLong.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DTUnsignedLongInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the UnsignedLong.</param>
        /// <param name="id">Identifier for the UnsignedLong.</param>
        /// <param name="childOf">Identifier of the parent element in which this UnsignedLong is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this UnsignedLong.</param>
        /// <param name="definedIn">Identifier of the partition in which this UnsignedLong is defined.</param>
        internal DTUnsignedLongInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.UnsignedLong)
        {
        ...
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this UnsignedLong.</param>
        /// <param name="definedIn">Identifier of the partition in which this UnsignedLong is defined.</param>
        /// <param name="entityKind">The kind of Entity, which may be other than UnsignedLong if this constructor is called from a derived class.</param>
        internal DTUnsignedLongInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type UnsignedLong in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type UnsignedLong.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:UnsignedLong;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTUnsignedLongInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTUnsignedLongInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTUnsignedLongInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTUnsignedLongInfo x, DTUnsignedLongInfo y)
        {
        ...
        /// <summary>
        /// Determines whether two <c>DTUnsignedLongInfo</c> objects are equal.
        /// </summary>
        /// <param name="x">One <c>DTUnsignedLongInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTUnsignedLongInfo</c> object to compare to the first.</param>
        ...
        /// <summary>
        /// Compares to another <c>DTUnsignedLongInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTUnsignedLongInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTUnsignedLongInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTUnsignedLongInfo)other);
        }
        ...
        /// <summary>
        /// Compares to another <c>DTUnsignedLongInfo</c> object.
        /// </summary>
        /// <param name="other">The other <c>DTUnsignedLongInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool Equals(DTUnsignedLongInfo other)
        {
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTUnsignedLongInfo)other);
        }
        ...
        {
            return otherObj is DTUnsignedLongInfo other && this.Equals(other);
        }
        ...
        /// <summary>
        /// Validate a <c>JsonElement</c> to determine whether it is a numeric value that conforms to the XSD definition of 'unsignedLong'.
        /// </summary>
        ...
        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTUnsignedLongInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTUnsignedLongInfo elementInfo = (DTUnsignedLongInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTUnsignedLongInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTUnsignedLongInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTUnsignedLongInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        /// <summary>
        /// Parse the properties in a JSON UnsignedLong object.
        /// </summary>
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:UnsignedLong;{this.LanguageMajorVersion}");
            }
        }
        ...
        private bool ValidateInstanceV4(JsonElement instanceElt, string instanceName, List<string> violations)
        {
            ...
            if (!ulong.TryParse(instanceElt.GetRawText(), out ulong _))
            {
                violations.Add($"{instanceElt.GetRawText()} does not conform to the XSD definition of 'unsignedLong'");
                return false;
            }
