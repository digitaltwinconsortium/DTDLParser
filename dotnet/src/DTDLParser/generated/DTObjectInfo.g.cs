...
namespace DTDLParser.Models
{
    ...
    /// </summary>
    public class DTObjectInfo : DTComplexSchemaInfo, ITypeChecker, IConstrainer, IPropertyInstanceBinder, IEquatable<DTObjectInfo>
    {
        ...
        private HashSet<int> fieldsAllowedVersionsV2 = new HashSet<int>() { 2 };

        private HashSet<int> fieldsAllowedVersionsV3 = new HashSet<int>() { 3 };

        private HashSet<int> fieldsAllowedVersionsV4 = new HashSet<int>() { 4 };
        ...
        private List<ValueConstraint> fieldsValueConstraints = null;
        ...
        static DTObjectInfo()
        {
            ...
            VersionlessTypes.Add("dtmi:dtdl:class:Object");
            ...
            BadTypeActionFormat[2] = "Provide a @type{line3} of Object, or provide a value for property '{property}'{line1} with @type of Object.";
            BadTypeActionFormat[3] = "Provide a @type{line3} of Object, or provide a value for property '{property}'{line1} with @type of Object.";
            BadTypeActionFormat[4] = "Provide a @type{line3} of Object, or provide a value for property '{property}'{line1} with @type of Object.";

            BadTypeCauseFormat[2] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Object.";
            BadTypeCauseFormat[3] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Object.";
            BadTypeCauseFormat[4] = "{layer}{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Object.";

            BadTypeLocatedCauseFormat[2] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Object.";
            BadTypeLocatedCauseFormat[3] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Object.";
            BadTypeLocatedCauseFormat[4] = "In {sourceName1}, property '{property}'{line1} has value{secondaryId:e}{line2} that does not have @type of Object.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DTObjectInfo"/> class.
        /// </summary>
        /// <param name="dtdlVersion">Version of DTDL used to define the Object.</param>
        /// <param name="id">Identifier for the Object.</param>
        /// <param name="childOf">Identifier of the parent element in which this Object is defined.</param>
        /// <param name="myPropertyName">Name of the property by which the parent DTDL element refers to this Object.</param>
        /// <param name="definedIn">Identifier of the partition in which this Object is defined.</param>
        internal DTObjectInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn)
            : base(dtdlVersion, id, childOf, myPropertyName, definedIn, DTEntityKind.Object)
        {
            this.Fields = new List<DTFieldInfo>();
        ...
        internal DTObjectInfo(int dtdlVersion, Dtmi id, Dtmi childOf, string myPropertyName, Dtmi definedIn, DTEntityKind entityKind)
        ...
        /// <summary>
        /// Get the DTMI that identifies type Object in the version of DTDL used to define this element.
        /// </summary>
        /// <value>The DTMI for the DTDL type Object.</value>
        public override Dtmi ClassId
        {
            get
            {
                return new Dtmi($"dtmi:dtdl:class:Object;{this.LanguageMajorVersion}");
            }
        }
        ...
        /// <summary>
        /// Determines whether two <c>DTObjectInfo</c> objects are not equal.
        /// </summary>
        /// <param name="x">One <c>DTObjectInfo</c> object to compare.</param>
        /// <param name="y">Another <c>DTObjectInfo</c> object to compare to the first.</param>
        /// <returns>True if not equal.</returns>
        public static bool operator !=(DTObjectInfo x, DTObjectInfo y)
        {
        ...
        /// <summary>
        /// Compares to another <c>DTObjectInfo</c> object, recursing through the entire subtree of object properties.
        /// </summary>
        /// <param name="other">The other <c>DTObjectInfo</c> object to compare to.</param>
        /// <returns>True if equal.</returns>
        public virtual bool DeepEquals(DTObjectInfo other)
        {
            return base.DeepEquals(other)
                ...
                && Helpers.AreListsDeepEqual(this.Fields, other.Fields)
        ...
        {
            return this.EntityKind == other?.EntityKind && this.DeepEquals((DTObjectInfo)other);
        }
        ...
        {
            return this.EntityKind == other?.EntityKind && this.Equals((DTObjectInfo)other);
        }
        ...
        {
            return otherObj is DTObjectInfo other && this.Equals(other);
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked
            {
                ...
                hashCode = (hashCode * 131) + Helpers.GetListIdHashCode(this.Fields);
        ...
        /// <summary>
        /// Validate a <c>JsonElement</c> to determine whether it is a JSON object that conforms to the specific Object element defined in the model.
        /// </summary>
        ...
        void IConstrainer.AddPropertyValueConstraint(string propertyName, ValueConstraint valueConstraint)
        {
            switch (propertyName)
            {
                ...
                case "displayName":
                    ...
                    break;
                case "fields":
                    if (this.fieldsValueConstraints == null)
                    {
                        this.fieldsValueConstraints = new List<ValueConstraint>();
                    }

                    this.fieldsValueConstraints.Add(valueConstraint);
                    break;
            }
        }
        ...
        void IPropertyInstanceBinder.AddInstanceProperty(string propertyName, string instancePropertyName)
        {
            ...
            {
                case "fields":
                    if (this.fieldsInstanceProperties == null)
                    {
                        this.fieldsInstanceProperties = new List<string>();
                    }

                    this.fieldsInstanceProperties.Add(instancePropertyName);
                    break;
            }
        }

        /// <summary>
        /// Parse an element encoded in a <see cref="JsonLdElement"/> into an object that is a subclass of type <c>DTObjectInfo</c>.
        /// </summary>
        ...
        internal static new bool TryParseElement(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, List<ValueConstraint> valueConstraints, AggregateContext aggregateContext, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi parentId, Dtmi definedIn, string propName, JsonLdProperty propProp, string dtmiSeg, string keyProp, bool idRequired, bool typeRequired, bool globalize, bool allowReservedIds, bool tolerateSolecisms, HashSet<int> allowedVersions, string inferredType)
        {
            ...
            DTObjectInfo elementInfo = (DTObjectInfo)baseElement;
        ...
        /// <summary>
        /// Parse a string property value as an identifier for type <c>DTObjectInfo</c>.
        /// </summary>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        /// <param name="valueConstraints">List of <see cref="ValueConstraint"/> to be added to <paramref name="elementPropertyConstraints"/>.</param>
        ...
        /// <param name="propName">The name of the property by which the parent refers to this element, used for auto ID generation.</param>
        /// <param name="propProp">The <see cref="JsonLdProperty"/> representing the source of the property by which the parent refers to this element.</param>
        /// <param name="elementInfo">The <see cref="DTObjectInfo"/> created.</param>
        /// <param name="aggregateContext">An <c>AggregateContext</c> object representing information retrieved from JSON-LD context blocks.</param>
        ...
        /// <summary>
        /// Parse elements encoded in a <see cref="JsonLdValueCollection"/> into objects of subclasses of type <c>DTObjectInfo</c>.
        /// </summary>
        /// <param name="model">The model to add the element to.</param>
        /// <param name="objectPropertyInfoList">A list of <c>ParsedObjectPropertyInfo</c> to add any object properties, which will be assigned after all parsing has completed.</param>
        /// <param name="elementPropertyConstraints">List of <c>ElementPropertyConstraint</c> to be checked after object property assignment.</param>
        ...
        internal override bool TrySetObjectProperty(string propertyName, string layer, JsonLdProperty propProp, DTEntityInfo element, string keyProp, string keyValue, ParsingErrorCollection parsingErrorCollection)
        {
            ...
            switch (propertyName)
            {
                ...
                case "dtmi:dtdl:property:fields;4":
                    ((List<DTFieldInfo>)this.Fields).Add((DTFieldInfo)element);
                    return true;
                default:
                    break;
            }
        ...
        internal override void ParsePropertiesV2(Model model, List<ParsedObjectPropertyInfo> objectPropertyInfoList, List<ElementPropertyConstraint> elementPropertyConstraints, AggregateContext aggregateContext, HashSet<Dtmi> immediateSupplementalTypeIds, List<string> immediateUndefinedTypes, ParsingErrorCollection parsingErrorCollection, JsonLdElement elt, string layer, Dtmi definedIn, bool globalize, bool allowReservedIds, bool tolerateSolecisms)
        {
            ...
            JsonLdProperty fieldsProperty = null;
                    ...
                    case "dtmi:dtdl:property:fields;2":
                        if (fieldsProperty != null)
                        {
                            parsingErrorCollection.Notify(
                                ...
                                propertyName: "fields",
                                incidentProperty: prop,
                                extantProperty: fieldsProperty,
                                layer: layer);
                        }
                        else
                        {
                            fieldsProperty = prop;
                            DTFieldInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.fieldsValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "fields", "name", null, 1, isPlural: true, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, tolerateSolecisms: tolerateSolecisms, allowedVersions: this.fieldsAllowedVersionsV2);
                        }
            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:fields;3":
                        ...
                        {
                            fieldsProperty = prop;
                            DTFieldInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.fieldsValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "fields", "name", null, 0, isPlural: true, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, tolerateSolecisms: tolerateSolecisms, allowedVersions: this.fieldsAllowedVersionsV3);
                        }
            ...
            foreach (JsonLdProperty prop in elt.Properties)
            {
                switch (prop.Name)
                {
                    ...
                    case "dtmi:dtdl:property:fields;4":
                        ...
                        {
                            fieldsProperty = prop;
                            DTFieldInfo.ParseValueCollection(model, objectPropertyInfoList, elementPropertyConstraints, this.fieldsValueConstraints, aggregateContext, parsingErrorCollection, prop, layer, this.Id, globalize ? null : definedIn ?? this.Id, "fields", "name", null, 0, isPlural: true, idRequired: false, typeRequired: false, globalize: globalize, allowReservedIds: allowReservedIds, tolerateSolecisms: tolerateSolecisms, allowedVersions: this.fieldsAllowedVersionsV4);
                        }
        ...
        internal override void WriteToJson(Utf8JsonWriter jsonWriter, bool includeClassId)
        {
            ...
            if (includeClassId)
            {
                jsonWriter.WriteString("ClassId", $"dtmi:dtdl:class:Object;{this.LanguageMajorVersion}");
            }

            jsonWriter.WritePropertyName("fields");
            jsonWriter.WriteStartArray();

            foreach (DTFieldInfo fieldsElt in this.Fields)
            {
                jsonWriter.WriteStringValue(fieldsElt.Id.ToString());
            }
        ...
        private bool ValidateInstanceV2(JsonElement instanceElt, string instanceName, List<string> violations)
        {
            ...
            {
                var matchFromFields = this.Fields.Where(val => val.DoesInstanceMatch(child.Value, child.Name)).FirstOrDefault();
                if (matchFromFields == null)
                {
                    violations.Add(child.Name != null ? $"\"{child.Name}\" does not match any name in schema" : $"{child.Value.GetRawText()} does not match any value in schema");
                    continue;
                }
                else if (!matchFromFields.ValidateInstance(child.Value, child.Name, violations))
                {
                    continue;
                }
            }
        ...
        {
            HashSet<object> fieldsNameSet = new HashSet<object>();
            foreach (DTFieldInfo item in this.Fields)
            {
                if (fieldsNameSet.Contains(item.Name))
                {
                    var dupItem = this.Fields.FirstOrDefault(i => i.JsonLdElements.Any(e => e.Value.Properties.Any(p => p.Name == "name" && p.Values.Values.Any(v => Helpers.AreObjectsLiteralEqual(v.LiteralValue, item.Name)))));
            ...
            if (this.Fields.Count > 30 && Helpers.CountUnique(this.Fields.Select(e => e.Id)) > 30)
            {
                JsonLdProperty propProp = this.JsonLdElements.FirstOrDefault(e => e.Value.Properties.Any(p => p.Name == "fields")).Value?.Properties?.First(p => p.Name == "fields");
                parsingErrorCollection.Notify(
                    "objectCountAboveMax",
                    elementId: this.Id,
                    propertyName: "fields",
                    observedCount: this.Fields.Count,
                    expectedCount: 30,
