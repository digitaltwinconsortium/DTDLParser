namespace DTDLParser
{
    ...
    /// <summary>
    /// Generator for tutorial program file.
    /// </summary>
    public class ProgramGenerator
    {
        ...
        public ProgramGenerator(string projectFolder, string markdownFilename, string projectName, StreamReader tutorialReader)
        {
