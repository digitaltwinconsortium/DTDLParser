...
This is an advanced addendum to the [Inspect object model](./Sample04_InspectObjectModel.md) sample.
An [asynchronous version](./Sample05_InspectObjectModelAdvancedAsync.md) of this sample is also available.
...
```C# Snippet:DtdlParserSample05_CreateModelParser
...
```C# Snippet:DtdlParserSample05_ObtainDtdlText
string jsonText =
@"{
...
```C# Snippet:DtdlParserSample05_CallParse
...
```C# Snippet:DtdlParserSample05_DisplayElements
...
```C# Snippet:DtdlParserSample05_DisplayDoubleTerm
...
```C# Snippet:DtdlParserSample05_GetInterfaceById
...
```C# Snippet:DtdlParserSample05_DisplayInterfaceContentPropertiesByKind
...
```C# Snippet:DtdlParserSample05_DisplayObjectModelEntityProperties
foreach (KeyValuePair<Dtmi, DTEntityInfo> modelElement in objectModel)
{
