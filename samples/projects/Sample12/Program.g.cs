/* This file was automatically generated from code snippets embedded in file Sample12_InspectSupplementalTypesAndPropertiesV2.md */
/* The associated project file Sample12.csproj and expected output file expect.txt were also automatically generated. */
...
namespace Sample12
{
    class Program
    {
        ...
        {
            #region Snippet:DtdlParserSample12_CreateModelParser
            var modelParser = new ModelParser();
            #endregion

            #region Snippet:DtdlParserSample12_GetSupplementalTypes
            IReadOnlyDictionary<Dtmi, DTSupplementalTypeInfo> supplementalTypes = modelParser.GetSupplementalTypes();
            #endregion

            #region Snippet:DtdlParserSample12_GetDistanceTypeInfo
            ...
            #region Snippet:DtdlParserSample12_DisplayDistanceTypeAndProperties
            ...
            #region Snippet:DtdlParserSample12_DisplayUnitTerm
            Console.WriteLine(ModelParser.GetTermOrUri(new Dtmi("dtmi:dtdl:property:unit;2")));
            #endregion

            #region Snippet:DtdlParserSample12_ObtainDtdlText
            string jsonText =
            @"{
            ...
            #region Snippet:DtdlParserSample12_CallParse
            IReadOnlyDictionary<Dtmi, DTEntityInfo> objectModel = modelParser.Parse(jsonText);
            #endregion

            #region Snippet:DtdlParserSample12_DisplayElements
            ...
            #region Snippet:DtdlParserSample12_DisplayDistanceTerm
            ...
            #region Snippet:DtdlParserSample12_DisplayTelemetryProperties
            ...
            #region Snippet:DtdlParserSample12_DisplayKilometreTypes
            ...
            #region Snippet:DtdlParserSample12_DisplayKilometreProperties
            ...
            #region Snippet:DtdlParserSample12_DisplayUnitValueIndepentOfVersion
