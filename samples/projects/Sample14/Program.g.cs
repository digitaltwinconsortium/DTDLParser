/* This file was automatically generated from code snippets embedded in file Sample14_ValidateDataAgainstSchemaDefinitions.md */
/* The associated project file Sample14.csproj and expected output file expect.txt were also automatically generated. */
...
namespace Sample14
{
    class Program
    {
        ...
        {
            #region Snippet:DtdlParserSample14_CreateModelParser
            var modelParser = new ModelParser();
            #endregion

            #region Snippet:DtdlParserSample14_ObtainDtdlText
            string jsonText =
            @"{
            ...
            #region Snippet:DtdlParserSample14_CallParse
            IReadOnlyDictionary<Dtmi, DTEntityInfo> objectModel = modelParser.Parse(jsonText);
            #endregion

            #region Snippet:DtdlParserSample14_DisplayElements
            ...
            #region Snippet:DtdlParserSample14_GetValidator
            ...
            #region Snippet:DtdlParserSample14_GetIntegerAndStringSchemas
            ...
            #region Snippet:DtdlParserSample14_DisplayIntegerAndStringValidation
            ...
            #region Snippet:DtdlParserSample14_GetDateValidator
            var dateSchema = objectModel[new Dtmi("dtmi:dtdl:instance:Schema:date;2")];
            #endregion

            #region Snippet:DtdlParserSample14_DisplayDateValidation
            ...
            #region Snippet:DtdlParserSample14_GetInstallationObject
            ...
            #region Snippet:DtdlParserSample14_DisplayObjectValidation
            ...
            #region Snippet:DtdlParserSample14_DisplayMultipleViolations
            Console.WriteLine(schemaValidator(installation.Schema, "INSTALLATION",
