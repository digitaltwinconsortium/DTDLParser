/* This file was automatically generated from code snippets embedded in file Sample05_InspectObjectModelAdvanced.md */
/* The associated project file Sample05.csproj and expected output file expect.txt were also automatically generated. */
...
namespace Sample05
{
    class Program
    {
        ...
        {
            #region Snippet:DtdlParserSample05_CreateModelParser
            var modelParser = new ModelParser();
            #endregion

            #region Snippet:DtdlParserSample05_ObtainDtdlText
            string jsonText =
            @"{
            ...
            #region Snippet:DtdlParserSample05_CallParse
            IReadOnlyDictionary<Dtmi, DTEntityInfo> objectModel = modelParser.Parse(jsonText);
            #endregion

            #region Snippet:DtdlParserSample05_DisplayElements
            ...
            #region Snippet:DtdlParserSample05_DisplayObjectModelEntityProperties
            foreach (KeyValuePair<Dtmi, DTEntityInfo> modelElement in objectModel)
            {
