...
A [synchronous version](./Sample02_FixInvalidDtdlModel.md) of this sample is also available.
...
```C# Snippet:DtdlParserSample02Async_CreateModelParser
...
```C# Snippet:DtdlParserSample02Async_ObtainInvalidDtdlText
string jsonText =
@"{
...
```C# Snippet:DtdlParserSample02Async_CallParseAsync
...
```C# Snippet:DtdlParserSample02Async_CallWait
try
{
    parseTask.Wait();
...
```C# Snippet:DtdlParserSample02Async_CorrectPropertyName
jsonText =
@"{
  ""@context"": ""dtmi:dtdl:context;3"",
  ""@id"": ""dtmi:example:anInterface;1"",
...
```C# Snippet:DtdlParserSample02Async_RepeatCallParseAsync
parseTask = modelParser.ParseAsync(jsonText);
```

[repeat]: # (Snippet:DtdlParserSample02Async_CallWait)
...
```C# Snippet:DtdlParserSample02Async_CorrectTypeName
jsonText =
@"{
  ""@context"": ""dtmi:dtdl:context;3"",
  ""@id"": ""dtmi:example:anInterface;1"",
...
[repeat]: # (Snippet:DtdlParserSample02Async_RepeatCallParseAsync)
...
```C# Snippet:DtdlParserSample02Async_AddRequiredProperty
jsonText =
@"{
  ""@context"": ""dtmi:dtdl:context;3"",
  ""@id"": ""dtmi:example:anInterface;1"",
