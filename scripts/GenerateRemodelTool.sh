...
dotnet run --project dotnet/gen/RemodelGenerator --no-launch-profile --configuration $DtdlModelParserBuildConfig dotnet/src/Remodel/generated dtdl/dtdl_digest.json dtdl/support/ObjectModelConventions.json dtdl/dtdl.json
