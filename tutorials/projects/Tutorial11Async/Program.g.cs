/* This file was automatically generated from code snippets embedded in file Tutorial11_PinpointErrorsInResolvedModelsAsync.md */
/* The associated project file Tutorial11Async.csproj and expected output file expect.txt were also automatically generated. */
...
namespace Tutorial11Async
{
    class Program
    {
        static void Main(string[] args)
        {
            #region Snippet:DtdlParserTutorial11Async_ObtainInvalidDtdlText
            string jsonText =
            @"{
            ...
            #region Snippet:DtdlParserTutorial11Async_ObtainReferencedDtdlText
            ...
            #region Snippet:DtdlParserTutorial11Async_CreateModelParserWithDtmiResolverAsync
            ...
            #region Snippet:DtdlParserTutorial11Async_CallParseAsync
            var parseTask = modelParser.ParseAsync(jsonText);
            #endregion

            #region Snippet:DtdlParserTutorial11Async_CallWait
            try
            {
                parseTask.Wait();
            ...
            #region Snippet:DtdlParserTutorial11Async_CreateDtdlParseLocator
            ...
            #region Snippet:DtdlParserTutorial11Async_CallParseAsyncWithLocator
            ...
            #region Snippet:DtdlParserTutorial11Async_RegisterDtdlResolveLocator
            ...
            #region Snippet:DtdlParserTutorial11Async_CorrectPropertyName
            jsonText =
            @"{
              ""@context"": ""dtmi:dtdl:context;3"",
              ""@id"": ""dtmi:example:anInterface;1"",
