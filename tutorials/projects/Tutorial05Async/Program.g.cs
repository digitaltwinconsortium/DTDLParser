/* This file was automatically generated from code snippets embedded in file Tutorial05_InspectObjectModelAdvancedAsync.md */
/* The associated project file Tutorial05Async.csproj and expected output file expect.txt were also automatically generated. */
...
namespace Tutorial05Async
{
    class Program
    {
        static void Main(string[] args)
        {
            #region Snippet:DtdlParserTutorial05Async_CreateModelParser
            var modelParser = new ModelParser();
            #endregion

            #region Snippet:DtdlParserTutorial05Async_ObtainDtdlText
            string jsonText =
            @"{
            ...
            #region Snippet:DtdlParserTutorial05Async_CallParseAsync
            var parseTask = modelParser.ParseAsync(jsonText);
            #endregion

            #region Snippet:DtdlParserTutorial05Async_CallWait
            parseTask.Wait();
            IReadOnlyDictionary<Dtmi, DTEntityInfo> objectModel = parseTask.Result;
            #endregion

            #region Snippet:DtdlParserTutorial05Async_DisplayElements
            ...
            #region Snippet:DtdlParserTutorial05Async_DisplayInterfaceContentValuesByKind
            ...
            #region Snippet:DtdlParserTutorial05Async_DisplayObjectModelEntityProperties
            foreach (KeyValuePair<Dtmi, DTEntityInfo> modelElement in objectModel)
            {
